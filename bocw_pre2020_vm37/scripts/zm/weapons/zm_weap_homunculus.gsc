...
// Params 0, eflags: 0x6
// Checksum 0x22f0c535, Offset: 0x170
// Size: 0x54
function private autoexec __init__system__() {
    system::register(#"zm_weap_homunculus", &function_70a657d8, &postinit, undefined, #"zm_weapons");
}

// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x5 linked
// Checksum 0x8023a4ba, Offset: 0x1d0
// Size: 0xa4
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x5 linked
// Checksum 0xe8e504e0, Offset: 0x280
// Size: 0x25c
function private postinit() {
    ...
    if (!isdefined(level.var_7604eabd)) {
        level.var_7604eabd = [];
    } else if (!isarray(level.var_7604eabd)) {
        level.var_7604eabd = array(level.var_7604eabd);
    }
    if (!isinarray(level.var_7604eabd, level.w_homunculus)) {
        level.var_7604eabd[level.var_7604eabd.size] = level.w_homunculus;
    }
    if (!isdefined(level.var_7604eabd)) {
        level.var_7604eabd = [];
    } else if (!isarray(level.var_7604eabd)) {
    ...
    if (!isinarray(level.var_7604eabd, level.w_homunculus_upgraded)) {
        level.var_7604eabd[level.var_7604eabd.size] = level.w_homunculus_upgraded;
    }
...
// Checksum 0xcc0c0b4, Offset: 0x4e8
// Size: 0x130
...
// Checksum 0xae4ee434, Offset: 0x620
// Size: 0x9a
function function_7b1ec82e(s_result) {
    if (s_result.weapon == level.w_homunculus || s_result.weapon == level.w_homunculus_upgraded) {
...
// Checksum 0x20928558, Offset: 0x6c8
// Size: 0x654
function function_dcaa7a4a(e_grenade, var_bbab4f84, var_c4a5788c, var_2f916462) {
    ...
    if (var_3fb36683 && is_true(e_grenade.var_45eaa114)) {
        ...
        if (var_3fb36683) {
            ...
            if (!is_true(e_grenade.var_255a121f)) {
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x1 linked
// Checksum 0x75c5fed7, Offset: 0xd28
// Size: 0xb0
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0x78e4d78d, Offset: 0xde0
// Size: 0x9c
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x0
// Checksum 0x337e86a5, Offset: 0xe88
// Size: 0x17e
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x1 linked
// Checksum 0x98cee993, Offset: 0x1010
// Size: 0x14a
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0x2dfdc365, Offset: 0x1168
// Size: 0x17e
function function_32b5113(ai_zombie) {
    self endon(#"death");
    ai_zombie endon(#"death");
    if (!zm_utility::check_point_in_playable_area(ai_zombie.origin) || is_true(ai_zombie.var_8ea10940) || is_true(ai_zombie.var_68139d12)) {
        return false;
    }
    if (!isdefined(ai_zombie.var_6f84b820)) {
        /#
            if (isdefined(ai_zombie.archetype)) {
                println("<dev string:x38>" + ai_zombie.archetype + "<dev string:x5e>");
            }
        #/
        return false;
    }
...
// Checksum 0xba0243d5, Offset: 0x12f0
// Size: 0x38e
function function_cc9535d0(var_c4a5788c, var_bbab4f84, *var_2f916462) {
    ...
    while (true) {
        ...
        wait 0.1;
        self zm_utility::create_zombie_point_of_interest(var_bbab4f84, var_2f916462, 10000);
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0xd8ce95c2, Offset: 0x1688
// Size: 0x9c
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0x15edc2e8, Offset: 0x1730
// Size: 0xa4
...
// Checksum 0xe2c738c7, Offset: 0x17e0
// Size: 0x23a
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 4, eflags: 0x1 linked
// Checksum 0xa8a4d8, Offset: 0x1a28
// Size: 0x134
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x5 linked
// Checksum 0xda9deb7e, Offset: 0x1b68
// Size: 0xc2
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x0
// Checksum 0xed56f29f, Offset: 0x1c38
// Size: 0x13a
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0x3f878ba4, Offset: 0x1d80
// Size: 0x74
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x1 linked
// Checksum 0x97dd0e47, Offset: 0x1e00
// Size: 0x68
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x1 linked
// Checksum 0xa60d0572, Offset: 0x1e70
// Size: 0x1a
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0xfa293788, Offset: 0x1e98
// Size: 0x270
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0x13589b77, Offset: 0x2110
// Size: 0x2b4
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 0, eflags: 0x1 linked
// Checksum 0xd14faf99, Offset: 0x23d0
// Size: 0x1ec
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 1, eflags: 0x1 linked
// Checksum 0xd37d8871, Offset: 0x25c8
// Size: 0x214
...
// Namespace zm_weap_homunculus/zm_weap_homunculus
// Params 2, eflags: 0x1 linked
// Checksum 0xe5fa9552, Offset: 0x27e8
// Size: 0x8c
