...
// Checksum 0x9c183c54, Offset: 0x268
// Size: 0x1334
function callback_playerconnect() {
    ...
    if ((!(is_true(level.intromovie) && !is_true(level.var_8efd30f2)) || !util::isfirstround()) && !sessionmodeiszombiesgame()) {
    ...
    if (!isdefined(self.pers[#"team"]) || isdefined(self.pers[#"needteam"])) {
        ...
        if (isdefined(level.var_331fe94b)) {
            var_4c542e39 = self [[ level.var_331fe94b ]](var_4c542e39);
        }
        /#
            var_b417b3ee = getdvarstring(#"scr_playerteams", "<dev string:x38>");
            playerteams = strtok(var_b417b3ee, "<dev string:x3c>");
    ...
    println("<dev string:x41>", num_con, "<dev string:x75>", num_exp);
...
// Checksum 0x4973fa94, Offset: 0x15a8
// Size: 0xa4
...
// Namespace player/player_connect
// Params 0, eflags: 0x5 linked
// Checksum 0x26fa4673, Offset: 0x1658
// Size: 0x77c
...
// Namespace player/player_connect
// Params 0, eflags: 0x5 linked
// Checksum 0x14c69053, Offset: 0x1de0
// Size: 0x49c
...
// Namespace player/player_connect
// Params 0, eflags: 0x5 linked
// Checksum 0x91d1caca, Offset: 0x2288
// Size: 0xde4
...
// Namespace player/player_connect
// Params 0, eflags: 0x5 linked
// Checksum 0xb9810106, Offset: 0x3078
// Size: 0x5c
