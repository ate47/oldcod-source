...
// Params 0, eflags: 0x6
// Checksum 0x58732fe7, Offset: 0x210
// Size: 0x3c
...
// Checksum 0x638fb9e1, Offset: 0x258
// Size: 0xec
...
// Checksum 0x605d75b7, Offset: 0x350
// Size: 0x22
...
// Checksum 0xe056aa3a, Offset: 0x380
// Size: 0x9c
...
// Namespace molotov/molotov
// Params 0, eflags: 0x1 linked
// Checksum 0xc802e9a, Offset: 0x428
// Size: 0x2e
...
// Namespace molotov/molotov
// Params 2, eflags: 0x1 linked
// Checksum 0x4dbcbe3e, Offset: 0x460
// Size: 0x254
...
// Checksum 0xf0457c90, Offset: 0x6c0
// Size: 0x84
...
// Namespace molotov/molotov
// Params 1, eflags: 0x1 linked
// Checksum 0x54e23782, Offset: 0x750
// Size: 0x42
...
// Namespace molotov/molotov
// Params 1, eflags: 0x1 linked
// Checksum 0xf7ac13e4, Offset: 0x7a0
// Size: 0x24
...
// Namespace molotov/molotov
// Params 1, eflags: 0x1 linked
// Checksum 0x3df57073, Offset: 0x7d0
// Size: 0x2c
...
// Namespace molotov/molotov
// Params 0, eflags: 0x1 linked
// Checksum 0x2d2afc54, Offset: 0x808
// Size: 0x7a
...
// Namespace molotov/molotov
// Params 1, eflags: 0x1 linked
// Checksum 0x5c5d96f5, Offset: 0x890
// Size: 0x84
...
// Namespace molotov/molotov
// Params 8, eflags: 0x1 linked
// Checksum 0x80fedd46, Offset: 0x920
// Size: 0x8fc
...
// Checksum 0x161a7179, Offset: 0x1228
// Size: 0x8c
...
// Namespace molotov/molotov
// Params 0, eflags: 0x1 linked
// Checksum 0xdbbf7079, Offset: 0x12c0
// Size: 0xe4
...
// Namespace molotov/molotov
// Params 2, eflags: 0x1 linked
// Checksum 0xb87c86c7, Offset: 0x13b0
// Size: 0xfe
...
// Checksum 0xec99ed0d, Offset: 0x14b8
// Size: 0xeb0
function function_8a03d3f3(owner, impactpos, startpos, normal, multiplier, rotation, killcament, *weapon, customsettings, team, var_e76400c0, wallnormal, var_693f108f) {
    defaultdistance = customsettings.var_6193a41b * rotation;
    ...
    fxcount = int(math::clamp(fxcount * rotation + 6, 6, customsettings.var_b650dc43));
    if (rotation < 0.04) {
        fxcount = 0;
    }
    function_31cc6bd9();
    if (function_31f342a2(normal, function_a3f6cdac(customsettings.var_6193a41b * 1.5)) && fxcount > 10) {
        fxcount = 7;
    }
    var_4997e17c = perpendicularvector(multiplier);
    for (fxindex = 0; fxindex < fxcount; fxindex++) {
        locations[#"point"][fxindex] = function_523961e2(normal, multiplier, var_4997e17c, fxindex, fxcount, defaultdistance, killcament);
    ...
    var_1cac1ca8 = multiplier[2] > 0.5;
    for (count = 0; count < fxcount; count++) {
        trace = hitpos(normal, locations[#"point"][count], locations[#"color"][count]);
        traceposition = trace[#"position"];
        ...
        if (!hitsomething) {
            var_e5d1793d = hitpos(traceposition, traceposition - multiplier * defaultdropdistance, locations[#"color"][count]);
        ...
        var_7ee25402 = rotatepointaroundaxis(var_4997e17c, multiplier, randangle);
        var_995eb37a = int(min(var_33ad9452 * rotation * trace[#"fraction"] + 1, var_33ad9452));
        for (var_ecef2fde = 0; var_ecef2fde < var_995eb37a && count % 2 == 0; var_ecef2fde++) {
            fraction = (var_ecef2fde + 1) / (var_995eb37a + 1);
            offsetpoint = normal + (traceposition - normal) * fraction + var_7ee25402 * var_c4b09917;
            var_9417df90 = hitpos(offsetpoint, offsetpoint - multiplier * defaultdropdistance, locations[#"color"][count]);
    ...
    var_7bf146f2 = getweapon("molotov_steam");
    var_6b23e1c9 = startpos + multiplier * 1.5;
    forward = (1, 0, 0);
    if (abs(vectordot(forward, multiplier)) > 0.999) {
        forward = (0, 0, 1);
    }
    if (!is_under_water(var_6b23e1c9)) {
        playfx(level._effect[#"hash_31b6cc906e6d0ae0"], var_6b23e1c9, forward, multiplier, 0, team);
        if (!isdefined(var_e76400c0)) {
            spawntimedfx(var_aecaaa11, var_6b23e1c9, multiplier, int(customsettings.var_b79d64a9), team);
        }
    }
    if (level.gameended) {
        return;
    ...
    var_4b424bc1.origin = normal;
    thread damageeffectarea(impactpos, normal, weapon, multiplier, var_aecaaa11, customsettings, rotation, var_e76400c0, wallnormal, var_693f108f, var_4b424bc1.var_46ee5246);
    thread function_9464e4ad(impactpos, normal, weapon, multiplier, var_aecaaa11, customsettings, rotation, var_e76400c0, wallnormal, var_693f108f, var_4b424bc1.var_46ee5246);
...
// Checksum 0x3b8aa663, Offset: 0x2370
// Size: 0x7c
...
/#
    ...
    // Namespace molotov/molotov
    // Params 5, eflags: 0x0
    // Checksum 0x5846eb99, Offset: 0x23f8
    // Size: 0xb4
...
// Checksum 0x4b91e7de, Offset: 0x24b8
// Size: 0x708
function damageeffectarea(owner, position, killcament, *normal, weapon, customsettings, radius_multiplier, var_e76400c0, wallnormal, var_cbaaea69, damageendtime) {
    ...
    if (sessionmodeiscampaigngame()) {
        ...
        badplace_cylinder("molotov", duration, killcament, radius + 15, height, "allies", "axis", "neutral");
    }
...
// Namespace molotov/molotov
// Params 0, eflags: 0x1 linked
// Checksum 0x4df9047e, Offset: 0x2bc8
// Size: 0x54
...
// Namespace molotov/molotov
// Params 11, eflags: 0x1 linked
// Checksum 0x83e0f6b2, Offset: 0x2c28
// Size: 0x3d4
function function_9464e4ad(owner, position, killcament, *normal, weapon, customsettings, radius_multiplier, var_e76400c0, wallnormal, var_cbaaea69, damageendtime) {
    ...
    self.var_ebf0b1c9 = [];
    self thread function_f8f4d9fc(damageendtime, position, killcament, fireeffectarea, var_289a74bc, normal, weapon, customsettings);
    while (gettime() < damageendtime) {
        damageapplied = 0;
        potential_targets = self weapons::function_356292be(position, killcament, radius);
        foreach (target in potential_targets) {
            if (!isdefined(target)) {
                continue;
            }
...
// Namespace molotov/molotov
// Params 8, eflags: 0x1 linked
// Checksum 0x978ff3ed, Offset: 0x3008
// Size: 0x128
function function_f8f4d9fc(damageendtime, owner, position, fireeffectarea, var_289a74bc, killcament, weapon, customsettings) {
    while (gettime() < damageendtime) {
        damageapplied = 0;
...
// Namespace molotov/molotov
// Params 2, eflags: 0x1 linked
// Checksum 0x68dffdff, Offset: 0x3138
// Size: 0x346
...
// Namespace molotov/molotov
// Params 1, eflags: 0x0
// Checksum 0x9857fc34, Offset: 0x3488
// Size: 0x162
...
// Namespace molotov/molotov
// Params 8, eflags: 0x1 linked
// Checksum 0x50745ef6, Offset: 0x35f8
// Size: 0x38c
function trytoapplyfiredamage(target, owner, position, fireeffectarea, var_289a74bc, killcament, weapon, customsettings) {
    if (!(isdefined(fireeffectarea) || isdefined(var_289a74bc)) || isdefined(target) && isdefined(target.var_8ef7113a) && target.var_8ef7113a) {
        return;
    }
    var_4c3c1b32 = 0;
    var_75046efd = 0;
    ...
    if (!var_be45d685 && (!isdefined(target.sessionstate) || target.sessionstate == "playing")) {
        ...
        if (trace[#"fraction"] == 1) {
            if (isplayer(target)) {
                ...
                target thread function_8422dabd(sourcepos, killcament, trace, position, weapon, customsettings, owner);
            } else {
...
// Namespace molotov/molotov
// Params 7, eflags: 0x1 linked
// Checksum 0xf4be61c6, Offset: 0x3990
// Size: 0x1bc
function damageinfirearea(origin, killcament, *trace, *position, weapon, customsettings, owner) {
    self endon(#"death");
    timer = 0;
    if (candofiredamage(position, self, customsettings.var_90bd7d92)) {
        /#
        ...
        params = getstatuseffect("dot_molotov");
        params.killcament = position;
        self status_effect::status_effect_apply(params, weapon, owner, 0, undefined, undefined, trace);
...
// Namespace molotov/molotov
// Params 7, eflags: 0x1 linked
// Checksum 0xfd2b16ff, Offset: 0x3b58
// Size: 0x1c2
function function_8422dabd(*origin, killcament, *trace, *position, weapon, customsettings, owner) {
    self endon(#"death");
    timer = 0;
    if (candofiredamage(position, self, customsettings.var_4bf1fc1f)) {
        var_4dd4e6ee = owner;
        if (!isdefined(self.var_84e41b20)) {
            self.var_84e41b20 = [];
        }
        ...
        /#
            ...
            println("<dev string:x93>" + var_4b6c578e + "<dev string:x9a>" + string(var_341dfe48) + "<dev string:xb4>" + time);
        #/
        self.var_ae639436 = var_4dd4e6ee;
    }
}
...
// Namespace molotov/molotov
// Params 7, eflags: 0x1 linked
// Checksum 0x42e9fe04, Offset: 0x3d28
// Size: 0x142
function function_37ddab3(*origin, killcament, *trace, *position, weapon, customsettings, owner) {
    self endon(#"death");
    timer = 0;
    if (candofiredamage(position, self, customsettings.var_8fbd03cb)) {
        var_4dd4e6ee = owner;
        if (!isdefined(self.var_84e41b20)) {
            self.var_84e41b20 = [];
        }
...
// Namespace molotov/molotov
// Params 0, eflags: 0x1 linked
// Checksum 0x1d4e2f14, Offset: 0x3e78
// Size: 0x146
...
// Namespace molotov/molotov
// Params 1, eflags: 0x1 linked
// Checksum 0xc80cc836, Offset: 0x3fc8
// Size: 0x4c
...
// Checksum 0x8df5ca8f, Offset: 0x4020
// Size: 0xe0
...
// Namespace molotov/molotov
// Params 3, eflags: 0x1 linked
// Checksum 0xcd3891e4, Offset: 0x4108
// Size: 0xc4
...
// Namespace molotov/molotov
// Params 2, eflags: 0x1 linked
// Checksum 0xfd148421, Offset: 0x41d8
// Size: 0x7c
...
// Namespace molotov/molotov
// Params 5, eflags: 0x1 linked
// Checksum 0x69a4a3ed, Offset: 0x4260
// Size: 0xac
