...
class class_d5e9830e {
    ...
    // Checksum 0x78acd8b2, Offset: 0x10b0
    // Size: 0x1e
    constructor() {
        tags = [];
        shaderconst = 0;
...
// Params 0, eflags: 0x2
// Checksum 0xd1f24a48, Offset: 0x278
// Size: 0x24
...
// Checksum 0xf886bb19, Offset: 0x2a8
// Size: 0x94
...
// Namespace archetype_damage_effects/archetype_damage_effects
// Params 0, eflags: 0x1 linked
// Checksum 0x7c31cbe1, Offset: 0x348
// Size: 0xb16
...
// Checksum 0x8a0c3a20, Offset: 0xe68
// Size: 0xd4
...
// Namespace archetype_damage_effects/archetype_damage_effects
// Params 4, eflags: 0x5 linked
// Checksum 0xdcd8b9d, Offset: 0xf48
// Size: 0x15e
...
// Checksum 0xf9c1c0a4, Offset: 0x1170
// Size: 0x4b6
function private _burnbody(localclientnum, prefix) {
    ...
    foreach (var_86661a11 in var_cdc643c6) {
        self thread _burnstage(localclientnum, var_86661a11.tags, 1, prefix);
...
// Checksum 0xa53e32a, Offset: 0x1630
// Size: 0x6c
...
// Namespace archetype_damage_effects/archetype_damage_effects
// Params 1, eflags: 0x4
// Checksum 0xb0766095, Offset: 0x16a8
// Size: 0x346
function private _burncorpse(localclientnum) {
    ...
    self.activefx = [];
    self thread _burnstage(localclientnum, stage1burntags, 0);
    self thread _burnstage(localclientnum, stage2burntags, 0);
    self thread _burnstage(localclientnum, stage3burntags, 0);
    self thread _burnstage(localclientnum, stage4burntags, 0);
    self thread _burnstage(localclientnum, stage5burntags, 0);
    maturemask = 0;
    if (util::is_mature()) {
        maturemask = 1;
    }
...
function actor_fire_fx(localclientnum, value, *burningduration) {
    ...
    case 0:
        ...
        break;
    case 1:
        self thread _burnbody(value);
        break;
    case 2:
        self thread _burnbody(value);
        break;
    case 3:
        self thread _burnbody(value, "smolder_");
        break;
    }
}
...
// Checksum 0x3e1d74d4, Offset: 0x1b88
// Size: 0x5c
function actor_fire_fx_state(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    self actor_fire_fx(fieldname, bwastimejump, 14);
}

// Namespace archetype_damage_effects/archetype_damage_effects
// Params 7, eflags: 0x1 linked
// Checksum 0x681f4c72, Offset: 0x1bf0
// Size: 0x132
function actor_char(localclientnum, *oldval, newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    switch (bwastimejump) {
    case 1:
        self thread actorcharrampto(fieldname, 1);
        break;
    case 0:
        self mapshaderconstant(fieldname, 0, "scriptVector0", 0);
        break;
    case 2:
        self mapshaderconstant(fieldname, 0, "scriptVector0", maturemask * 1);
        break;
    }
}
...
// Checksum 0x797c01c0, Offset: 0x1d30
// Size: 0x16c
