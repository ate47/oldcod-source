...
class csceneactor : csceneobject {
    ...
    // Checksum 0x42738e24, Offset: 0x198
    // Size: 0x22
    constructor() {
        _b_set_goal = 1;
    }
    ...
    // Checksum 0x4bdfb0c0, Offset: 0x508
    // Size: 0x5a
    function track_goal() {
    ...
    // Namespace csceneactor/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0xc61278cf, Offset: 0x6b0
    // Size: 0x11c
    ...
    // Namespace csceneactor/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0x24a4b136, Offset: 0x900
    // Size: 0x15c
    ...
    // Namespace csceneactor/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0x20fbd1df, Offset: 0x1c8
    // Size: 0x64
    function _spawn_ent() {
    ...
    // Namespace csceneactor/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0xcf9ddec7, Offset: 0x3e0
    // Size: 0x11c
    function _cleanup() {
    ...
    // Checksum 0x23dab247, Offset: 0x7d8
    // Size: 0x11c
    ...
    // Namespace csceneactor/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0xca23cfb4, Offset: 0x2e0
    // Size: 0xf4
    function _prepare() {
        if (isactor(_e)) {
            thread track_goal();
    ...
    // Namespace csceneactor/scene_actor_shared
    // Params 1, eflags: 0x1 linked
    // Checksum 0x2ced2c2a, Offset: 0x238
    // Size: 0x9c
    ...
    // Namespace csceneactor/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0xde9199c4, Offset: 0x570
    // Size: 0x134
    function set_goal() {
        if (!(_e.scene_spawned === _o_scene._s.name && isdefined(_e.target))) {
            if (!isdefined(_e.script_forcecolor)) {
                if (!_e flag::get(#"anim_reach")) {
                    ...
                    if (_b_set_goal && is_true(_s.var_37ccbf49)) {
...
class cscenefakeactor : csceneobject, csceneactor {
    ...
    // Params 0, eflags: 0x1 linked
    // Checksum 0xc95d1207, Offset: 0x20a0
    // Size: 0x294
    function _spawn_ent() {
        if (isspawner(_e)) {
...
class cscenecompanion : csceneobject, csceneactor {
    ...
    // Params 0, eflags: 0x1 linked
    // Checksum 0xf98e6793, Offset: 0x3b00
    // Size: 0x1e4
    function _spawn_ent() {
        if (isspawner(_e)) {
    ...
    // Namespace cscenecompanion/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0x6a104860, Offset: 0x3cf0
    // Size: 0x7c
    function _cleanup() {
    ...
    // Checksum 0x71585f2b, Offset: 0x3e20
    // Size: 0xe4
    ...
    // Namespace cscenecompanion/scene_actor_shared
    // Params 1, eflags: 0x1 linked
    // Checksum 0x3b22ad8c, Offset: 0x3d78
    // Size: 0x9c
    ...
    // Namespace cscenecompanion/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0xf118cc34, Offset: 0x3a28
    // Size: 0xcc
    function _spawn() {
        if (!isdefined(level.heroes)) {
            level.heroes = [];
...
class cscenesharedcompanion : cscenecompanion, csceneobject, csceneactor {
    ...
    // Params 0, eflags: 0x1 linked
    // Checksum 0x3e3b0899, Offset: 0x5780
    // Size: 0xbc
    function _cleanup() {
        if (!isdefined(level.heroes)) {
            level.heroes = [];
    ...
    // Namespace cscenesharedcompanion/scene_actor_shared
    // Params 0, eflags: 0x1 linked
    // Checksum 0x2977f74d, Offset: 0x56b8
    // Size: 0xc0
    function _prepare() {
        if (!isdefined(level.heroes)) {
            level.heroes = [];
