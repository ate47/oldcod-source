...
// Checksum 0x639d136f, Offset: 0xf0
// Size: 0x1b4
...
// Checksum 0x9790590e, Offset: 0x2b0
// Size: 0xac
...
// Namespace smart_bomb/smart_bomb
// Params 1, eflags: 0x1 linked
// Checksum 0x4e918703, Offset: 0x368
// Size: 0x12c
...
// Namespace smart_bomb/smart_bomb
// Params 1, eflags: 0x1 linked
// Checksum 0x43d81e61, Offset: 0x4a0
// Size: 0x1c4
...
// Namespace smart_bomb/smart_bomb
// Params 1, eflags: 0x1 linked
// Checksum 0x56d5fc30, Offset: 0x670
// Size: 0x9fc
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0xb9e7ea33, Offset: 0x1078
// Size: 0x63a
function hunt_enemy() {
    foundpath = 0;
    targetpos = function_dcecac3c();
    if (isdefined(targetpos)) {
        if (distancesquared(self.origin, targetpos) > function_a3f6cdac(400) && self isposinclaimedlocation(targetpos)) {
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0xf0f0ce56, Offset: 0x16c0
// Size: 0x11e
function prevent_stuck() {
    ...
    while (true) {
        if (isdefined(previous_origin) && distancesquared(previous_origin, self.origin) < function_a3f6cdac(0.1) && !is_true(level.bzm_worldpaused)) {
            count++;
        } else {
...
// Checksum 0x63664d15, Offset: 0x17e8
// Size: 0x14c
function check_detonation_dist(origin, enemy) {
    if (isdefined(enemy) && isalive(enemy)) {
        ...
        if (distance2dsquared(targetpoint, origin) < function_a3f6cdac(self.settings.detonation_distance) && (abs(targetpoint[2] - origin[2]) < self.settings.detonation_distance || abs(targetpoint[2] - self.settings.jump_height - origin[2]) < self.settings.detonation_distance)) {
            return true;
        }
    }
    return false;
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x88a966f2, Offset: 0x1940
// Size: 0x23c
...
// Namespace smart_bomb/smart_bomb
// Params 1, eflags: 0x1 linked
// Checksum 0x596355da, Offset: 0x1b88
// Size: 0xdc
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x67df2f8c, Offset: 0x1c70
// Size: 0x98
...
// Namespace smart_bomb/smart_bomb
// Params 1, eflags: 0x1 linked
// Checksum 0x1e4ff3e, Offset: 0x1d10
// Size: 0x450
function function_ded83def(lastenemy) {
    if (isdefined(self.enemy) && isplayer(self.enemy)) {
        ...
        if (disttoenemysquared < function_a3f6cdac(250)) {
            if (lastdisttoenemysquared > function_a3f6cdac(250) && !is_true(self.servershortout) && isdefined(self.sndalias[#"vehclose250"])) {
                self playsoundtoplayer(self.sndalias[#"vehclose250"], self.enemy);
            }
        } else if (disttoenemysquared < function_a3f6cdac(750)) {
            if (lastdisttoenemysquared > function_a3f6cdac(750) && !is_true(self.servershortout) && isdefined(self.sndalias[#"vehtargeting"])) {
                self playsoundtoplayer(self.sndalias[#"vehtargeting"], self.enemy);
            }
        } else if (disttoenemysquared < function_a3f6cdac(1500)) {
            if (lastdisttoenemysquared > function_a3f6cdac(1500) && !is_true(self.servershortout) && isdefined(self.sndalias[#"vehclose1500"])) {
        ...
        lastdisttoenemysquared += function_a3f6cdac(10);
    }
}

// Namespace smart_bomb/smart_bomb
// Params 1, eflags: 0x1 linked
// Checksum 0x76d5c1ba, Offset: 0x2168
// Size: 0x7c
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x83c464e9, Offset: 0x21f0
// Size: 0x470
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x2139e6d5, Offset: 0x2668
// Size: 0x35c
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x6209d1ba, Offset: 0x29d0
// Size: 0x364
function path_update_interrupt() {
    ...
    while (true) {
        if (isdefined(self.current_pathto_pos)) {
            ...
            targetpos = function_dcecac3c();
            if (isdefined(targetpos)) {
                if (distancesquared(self.origin, targetpos) > function_a3f6cdac(400)) {
...
// Checksum 0x1b9b6c81, Offset: 0x2d40
// Size: 0xfa
...
// Namespace smart_bomb/smart_bomb
// Params 1, eflags: 0x1 linked
// Checksum 0xf00d00ba, Offset: 0x2e48
// Size: 0x15c
...
// Checksum 0xc1322f88, Offset: 0x2fb0
// Size: 0x2e8
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x453aa501, Offset: 0x32a0
// Size: 0xba
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0xf69b5a86, Offset: 0x3368
// Size: 0x8c
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x8c339469, Offset: 0x3400
// Size: 0x80
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x14875e8f, Offset: 0x3488
// Size: 0x130
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x14676926, Offset: 0x35c0
// Size: 0x164
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0x17a2f4ed, Offset: 0x3730
// Size: 0x34
...
// Namespace smart_bomb/smart_bomb
// Params 0, eflags: 0x1 linked
// Checksum 0xaf6b9f1a, Offset: 0x3770
// Size: 0x3c
