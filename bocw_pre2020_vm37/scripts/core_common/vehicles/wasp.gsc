...
// Namespace wasp/wasp
// Params 0, eflags: 0x6
// Checksum 0xbeda9119, Offset: 0x280
// Size: 0x3c
...
// Checksum 0x786b46f9, Offset: 0x2c8
// Size: 0x74
...
// Checksum 0x8b37a028, Offset: 0x348
// Size: 0x27c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0xc3b2966b, Offset: 0x5d0
// Size: 0x2d4
...
// Checksum 0x63af7e7a, Offset: 0x8b0
// Size: 0x39c
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0xb8fb1750, Offset: 0xc58
// Size: 0x65c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0x58bb89c2, Offset: 0x12c0
// Size: 0x4c
...
// Checksum 0xccf4b9bd, Offset: 0x1318
// Size: 0x5a4
function fall_and_bounce(killonimpact_speed, killonimpact_time, killonimpact = 0) {
    ...
    fallstart = gettime();
    while (bouncedtime < maxbouncetime && lengthsquared(self.velocity) > function_a3f6cdac(10)) {
        waitresult = self waittill(#"veh_collision");
        impact_vel = waitresult.velocity;
        normal = waitresult.normal;
        if (killonimpact) {
            self kill();
        } else if (lengthsquared(impact_vel) > function_a3f6cdac(killonimpact_speed) || util::timesince(fallstart) > killonimpact_time && lengthsquared(impact_vel) > function_a3f6cdac(killonimpact_speed * 0.8)) {
            self kill();
        ...
        if (shouldbounce) {
            ...
            stablizescale = mapfloat(function_a3f6cdac(5), function_a3f6cdac(60), 0.1, 1, velocitylengthsqr);
            ang_vel = self getangularvelocity();
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0xa56720a7, Offset: 0x18c8
// Size: 0x244
...
/#
    ...
    // Namespace wasp/wasp
    // Params 0, eflags: 0x0
    // Checksum 0x74fa3089, Offset: 0x1b18
    // Size: 0x10a
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0xe9e5f43e, Offset: 0x1c30
// Size: 0x332
...
// Namespace wasp/wasp
// Params 3, eflags: 0x1 linked
// Checksum 0xc2731fb2, Offset: 0x1f70
// Size: 0x146
function state_guard_can_enter(*from_state, *to_state, *connection) {
    ...
    if (distancesquared(self.owner.origin, self.enemy.origin) > function_a3f6cdac(1200) && distancesquared(self.origin, self.enemy.origin) > function_a3f6cdac(300)) {
        return true;
    }
    if (!ispointinnavvolume(self.origin, "navvolume_small")) {
        return true;
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x6d173a4e, Offset: 0x20c0
// Size: 0x4c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0x4f3cb7ec, Offset: 0x2118
// Size: 0x72
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0xbacc00da, Offset: 0x2198
// Size: 0x3e
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x7266761a, Offset: 0x21e0
// Size: 0x64
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0xff8d6973, Offset: 0x2250
// Size: 0xe4
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x8c97154, Offset: 0x2340
// Size: 0x850
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x922cb1f5, Offset: 0x2b98
// Size: 0x84
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0x2a1a6928, Offset: 0x2c28
// Size: 0x52c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0xfaad004c, Offset: 0x3160
// Size: 0x254
function path_update_interrupt() {
    ...
    while (true) {
        ...
        if (isdefined(self.enemy) && isalive(self)) {
            ...
            if (self cansee(self.enemy) && distance2dsquared(self.origin, self.enemy.origin) < function_a3f6cdac(250)) {
                self notify(#"near_goal");
            }
        }
        wait 0.2;
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0xfa33e4b5, Offset: 0x33c0
// Size: 0x2d8
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0x4b4be3f5, Offset: 0x36a0
// Size: 0x3e
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0xaef03a00, Offset: 0x36e8
// Size: 0x1e2
function update_leader() {
    ...
    foreach (guy in team_mates) {
        if (isdefined(guy.archetype) && guy.archetype == "wasp") {
            ...
            if (distancesquared(self.origin, guy.origin) > function_a3f6cdac(700)) {
                continue;
            }
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x12db60eb, Offset: 0x38d8
// Size: 0x150
function should_fly_forward(distancetogoalsq) {
    if (self.always_face_enemy === 1) {
        return false;
    }
    if (distancetogoalsq < function_a3f6cdac(250)) {
        return false;
    }
    if (isdefined(self.enemy)) {
    ...
    if (distancetogoalsq > function_a3f6cdac(400)) {
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x668a3f37, Offset: 0x3a30
// Size: 0x12c
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x790eb67d, Offset: 0x3b68
// Size: 0x87a
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0x30575dec, Offset: 0x43f0
// Size: 0x2b2
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0xf1f0887b, Offset: 0x46b0
// Size: 0xf36
...
// Checksum 0x28320716, Offset: 0x55f0
// Size: 0xb2
...
// Checksum 0xd055ecbd, Offset: 0x56b0
// Size: 0x86
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0x16a38ca7, Offset: 0x5740
// Size: 0xb4
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0x870ae98e, Offset: 0x5800
// Size: 0x82
...
// Namespace wasp/wasp
// Params 0, eflags: 0x1 linked
// Checksum 0x35e28a1b, Offset: 0x5890
// Size: 0x148
...
// Namespace wasp/wasp
// Params 2, eflags: 0x0
// Checksum 0xf10979c0, Offset: 0x59e0
// Size: 0x108
...
// Checksum 0x6ee989c6, Offset: 0x5af0
// Size: 0x14e
...
// Namespace wasp/wasp
// Params 2, eflags: 0x5 linked
// Checksum 0x88918e7e, Offset: 0x5c48
// Size: 0x14e
...
// Namespace wasp/wasp
// Params 2, eflags: 0x0
// Checksum 0x522f20a5, Offset: 0x5da0
// Size: 0xf8
...
// Checksum 0xadc13a9, Offset: 0x5ea0
// Size: 0x1b8
...
// Namespace wasp/wasp
// Params 1, eflags: 0x1 linked
// Checksum 0xa6d28b87, Offset: 0x6060
// Size: 0xce
...
// Namespace wasp/wasp
// Params 0, eflags: 0x5 linked
// Checksum 0x59fdab23, Offset: 0x6138
// Size: 0x9c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0xf1a225fb, Offset: 0x61e0
// Size: 0x58
...
// Namespace wasp/wasp
// Params 2, eflags: 0x0
// Checksum 0xf73c67bb, Offset: 0x6240
// Size: 0x298
