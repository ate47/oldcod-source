...
// Params 0, eflags: 0x6
// Checksum 0xd4b831ee, Offset: 0x160
// Size: 0x3c
...
// Checksum 0xa4c59be, Offset: 0x1a8
// Size: 0x10c
...
// Checksum 0xbebd0514, Offset: 0x2c0
// Size: 0x24
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x1 linked
// Checksum 0x49f762b9, Offset: 0x2f0
// Size: 0x26
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x1 linked
// Checksum 0x2a2aa998, Offset: 0x320
// Size: 0x54
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x1 linked
// Checksum 0x37a47748, Offset: 0x380
// Size: 0x29c
function function_9eeebbfd(localclientnum) {
    self endon(#"death");
    self util::waittill_dobj(localclientnum);
    localplayer = function_5c10bd79(localclientnum);
    if (getuimodelvalue(getuimodel(function_1df4c3b0(localclientnum, #"hash_6f4b11a0bee9b73d"), "squadSpawnActive")) == 1) {
    ...
    if (isdefined(localplayer)) {
        ...
        if (var_bbf88336 && isdefined(self.owner) && self.owner == localplayer || !var_bbf88336 && self function_ca024039()) {
            if (!isdefined(localplayer.var_4bec2e4)) {
                localplayer.var_4bec2e4 = [];
            }
            localplayer.var_4bec2e4[self getentitynumber()] = self;
            self function_a7bc52b0(localclientnum);
            self thread function_2c8858f7(localclientnum);
        } else if (!self function_ca024039()) {
            if (!isdefined(localplayer.var_a8644947)) {
                localplayer.var_a8644947 = [];
            }
            localplayer.var_a8644947[self getentitynumber()] = self;
...
// Checksum 0x4349221, Offset: 0x628
// Size: 0x214
function private function_cf419a0(localclientnum, icon, range) {
    ...
    if (!(level.var_8ddf6d3d.var_ec25308b === 1)) {
        var_a2774043 function_27351ff6();
    }
    if (!isdefined(self.var_12dddf05)) {
        self.var_12dddf05 = [];
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x1 linked
// Checksum 0x79fa918f, Offset: 0x848
// Size: 0x124
function function_a7bc52b0(localclientnum) {
    ...
    function_cf419a0(localclientnum, "ui_hud_minimap_listening_device_flipbook_inner", var_9b87de48);
    jammer::register(self, &function_298eeca8);
}

// Namespace listening_device/listening_device
// Params 7, eflags: 0x1 linked
// Checksum 0x7b0aec5f, Offset: 0x978
// Size: 0x108
...
// Namespace listening_device/listening_device
// Params 7, eflags: 0x1 linked
// Checksum 0x14e7c21d, Offset: 0xa88
// Size: 0x2d0
function function_a7c5eafc(localclientnum, *oldval, *newval, *bnewent, *binitialsnap, *fieldname, *bwastimejump) {
    ...
    if (isdefined(localplayer.var_4bec2e4[self getentitynumber()])) {
        localplayer.var_4bec2e4[self getentitynumber()] = undefined;
        arrayremovevalue(localplayer.var_4bec2e4, undefined, 1);
        foreach (icon in self.var_12dddf05) {
...
// Checksum 0x73fd45de, Offset: 0xd60
// Size: 0x5e
...
// Checksum 0x3a5e7b1b, Offset: 0xdc8
// Size: 0xf2
...
// Checksum 0x7201e9b2, Offset: 0xec8
// Size: 0x1d0
function function_9ba59a68(*localclientnum, localplayer, radius, var_33d2c2e8) {
    var_3fdb367c = [];
    if (isdefined(localplayer.var_4bec2e4)) {
        arrayremovevalue(localplayer.var_4bec2e4, undefined, 1);
        var_3fdb367c = localplayer.var_4bec2e4;
    }
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x1 linked
// Checksum 0x4a23ec59, Offset: 0x10a0
// Size: 0x8ac
function monitor_detectnearbyenemies(localclientnum) {
    ...
    while (true) {
        ...
        var_c1f7d98b = localplayer function_9ba59a68(localclientnum, localplayer, var_93ef2e00, 1);
        ...
        foreach (device in var_c1f7d98b) {
            ...
            foreach (sixthsenseent in sixthsenseents) {
                ...
                if (var_7aeac1e7) {
                    ...
                    if (isdefined(sixthsenseent.var_6766ff79)) {
                        if (gettime() - sixthsenseent.var_6766ff79 > (isdefined(bundle.var_10ad1e72) ? bundle.var_10ad1e72 : 0)) {
...
// Checksum 0x69dadaca, Offset: 0x1958
// Size: 0x638
...
// Checksum 0xceeab112, Offset: 0x1f98
// Size: 0x104
...
// Checksum 0x67a75c24, Offset: 0x20a8
// Size: 0xe8
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x5 linked
// Checksum 0x20db19b1, Offset: 0x2198
// Size: 0x56
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x5 linked
// Checksum 0x7e081d1, Offset: 0x21f8
// Size: 0x3c
...
// Namespace listening_device/listening_device
// Params 4, eflags: 0x1 linked
// Checksum 0x7259ce04, Offset: 0x2240
// Size: 0x1b0
function function_c4aa9cb(*localclientnum, localplayer, radius, var_33d2c2e8) {
    var_3fdb367c = [];
    if (isdefined(localplayer.var_a8644947)) {
        arrayremovevalue(localplayer.var_a8644947, undefined, 1);
        var_3fdb367c = localplayer.var_a8644947;
    }
    radiussq = function_a3f6cdac(radius);
    var_48d4da6b = [];
    foreach (listening_device in var_3fdb367c) {
...
// Namespace listening_device/listening_device
// Params 1, eflags: 0x1 linked
// Checksum 0x1b87681d, Offset: 0x23f8
// Size: 0x57c
