...
// Namespace ball/ball
// Params 0, eflags: 0x2
// Checksum 0xf2968fde, Offset: 0x590
// Size: 0x3c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x52ae9d1a, Offset: 0x5d8
// Size: 0x10c
function __init__() {
    ...
    globallogic_spawn::addsupportedspawnpointtype("uplink");
}

// Namespace ball/gametype_init
// Params 1, eflags: 0x40
// Checksum 0x492606c2, Offset: 0x6f0
// Size: 0x4ac
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x8838e088, Offset: 0xba8
// Size: 0x32
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xbb0b5b7c, Offset: 0xbe8
// Size: 0x1ae
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x2c2043bd, Offset: 0xda0
// Size: 0x2c4
function onstartgametype() {
    level.var_d566bdba = getweapon("ball_world");
    level.var_aff3334d = getweapon("ball_world_pass");
    if (overtime::is_overtime_round()) {
        if (!isdefined(game.var_dda157bc)) {
            game.var_dda157bc = [];
            game.var_dda157bc[#"allies"] = [[ level._getteamscore ]](#"allies");
            game.var_dda157bc[#"axis"] = [[ level._getteamscore ]](#"axis");
        }
        [[ level._setteamscore ]](#"allies", 0);
        [[ level._setteamscore ]](#"axis", 0);
        if (isdefined(game.var_f3b50e28)) {
            util::registerscorelimit(game.var_f3b50e28, game.var_f3b50e28);
        } else {
            util::registerscorelimit(1, 1);
        }
        if (isdefined(game.var_68805c9b)) {
            util::registertimelimit(game.var_68805c9b / 60000, game.var_68805c9b / 60000);
        } else {
            util::registertimelimit(0, 1440);
        }
        if (game.overtime_round == 1) {
        } else if (isdefined(game.overtime_first_winner)) {
    ...
    level setup_objectives();
    globallogic_utils::print_map_errors();
}

// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xf360efbf, Offset: 0x1070
// Size: 0xb0
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xfa64662c, Offset: 0x1130
// Size: 0xa8
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x9ea21ecb, Offset: 0x11e0
// Size: 0x9c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x4e8bb960, Offset: 0x1288
// Size: 0x54
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x62944fa6, Offset: 0x12e8
// Size: 0x24
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x80f724d1, Offset: 0x1318
// Size: 0x4
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x60de52f4, Offset: 0x1328
// Size: 0xa8
function function_954bf69b() {
    if (level.teambased) {
        foreach (team, _ in level.teams) {
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x114ba7fc, Offset: 0x13d8
// Size: 0x54
function function_972a6af9() {
    function_83143ec0();
    if (!function_954bf69b()) {
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x7da54569, Offset: 0x1438
// Size: 0x6c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x89504e0c, Offset: 0x14b0
// Size: 0x196
...
// Namespace ball/ball
// Params 9, eflags: 0x0
// Checksum 0xa7c2ac3f, Offset: 0x1650
// Size: 0x5d0
    ...
    if (isdefined(self.carryobject)) {
        ...
        if (isdefined(attacker) && isplayer(attacker) && attacker != self) {
            ...
            if (attacker.team != self.team) {
                scoreevents::processscoreevent(#"hash_3a5eaaf8d03d8f10", attacker, self, weapon);
            ...
            level thread popups::displayteammessagetoteam(#"hash_2a9e3ce6905b87b9", self, self.team, undefined, undefined);
            level thread popups::displayteammessagetoteam(#"hash_2a9e3ce6905b87b9", self, otherteam, undefined, undefined);
        }
    } else if (isdefined(attacker.carryobject) && attacker.team != self.team) {
        scoreevents::processscoreevent(#"hash_26d28bf9e79156e0", attacker, self, weapon);
    }
    foreach (ball in level.balls) {
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x69c16ede, Offset: 0x1c28
// Size: 0x9a
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x9b808fcb, Offset: 0x1cd0
// Size: 0x18e
function onendround(var_c3d87d03) {
    winningteam = round::get_winning_team();
    if (!isdefined(winningteam) || round::get_flag("tie")) {
        return;
    }
    if (round::get_flag("overtime")) {
        game.overtime_first_winner = winningteam;
        game.var_f3b50e28 = getteamscore(winningteam);
        game.overtime_time_to_beat[#"ball"] = globallogic_utils::gettimepassed();
        game.var_68805c9b = globallogic_utils::gettimepassed();
        return;
    }
    game.overtime_second_winner[#"ball"] = winningteam;
    game.var_7c5098a[#"ball"] = getteamscore(winningteam);
    game.overtime_best_time[#"ball"] = globallogic_utils::gettimepassed();
    game.var_68805c9b = globallogic_utils::gettimepassed();
}

// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xe555dfe, Offset: 0x1e68
// Size: 0x29c
function onendgame(var_c3d87d03) {
    winningteam = round::get_winning_team();
    if (match::get_flag("overtime")) {
        ...
        if (isdefined(game.overtime_first_winner)) {
            ...
            if (game.overtime_first_winner == winningteam) {
                level.endvictoryreasontext = #"hash_30307c24e2b87002";
                level.enddefeatreasontext = #"hash_6f446f2ca3839f9d";
            } else {
                level.endvictoryreasontext = #"hash_30307c24e2b87002";
                level.enddefeatreasontext = #"hash_4331740e0976c937";
            }
        }
        if (level.scoreroundwinbased) {
            ...
            if (isdefined(game.var_f3b50e28) && (!isdefined(game.var_ec37b672) || game.var_f3b50e28 > game.var_ec37b672)) {
                var_9dfe2c62 = game.var_f3b50e28;
            } else {
                var_9dfe2c62 = game.var_ec37b672;
            }
            foreach (team, _ in level.teams) {
                score = game.var_dda157bc[team];
                if (team === winningteam) {
                    score += var_9dfe2c62;
                }
    ...
    globallogic_defaults::onendgame();
}

// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x945d2aa4, Offset: 0x2110
// Size: 0x1d6
...
// Namespace ball/ball
// Params 4, eflags: 0x0
// Checksum 0x742426a8, Offset: 0x22f0
// Size: 0x80
...
// Namespace ball/ball
// Params 4, eflags: 0x0
// Checksum 0x3b2eac75, Offset: 0x2378
// Size: 0x92
...
// Namespace ball/ball
// Params 6, eflags: 0x0
// Checksum 0x24133735, Offset: 0x2418
// Size: 0x150
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x43a1a163, Offset: 0x2570
// Size: 0x96
function function_18bf10c7(team) {
    var_837a6c85 = util::function_82f4ab63(team);
    var_29d2b927 = undefined;
    switch (var_837a6c85) {
    case #"axis":
        var_29d2b927 = "ball_goal_axis";
        break;
    case #"allies":
        var_29d2b927 = "ball_goal_allies";
        break;
    }
    return var_29d2b927;
}
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xf9be922f, Offset: 0x2610
// Size: 0x360
function setup_objectives() {
    ...
    if (level.ball_starts.size == 0) {
        globallogic_utils::add_map_error("Could not find ball_start in the map.");
        return;
    }
    ...
    foreach (team, _ in level.teams) {
        var_f3e319ca = function_18bf10c7(team);
        trigger = getent(var_f3e319ca, "targetname");
        if (isdefined(trigger)) {
            level.ball_goals[team] = function_b22de10a(trigger, team);
            continue;
        }
        level.ball_goals[team] = undefined;
        globallogic_utils::add_map_error("Could not find ball goal trigger " + var_f3e319ca);
    }
}

// Namespace ball/ball
// Params 2, eflags: 0x0
// Checksum 0x1e6fc7a8, Offset: 0x2978
// Size: 0x1ee
function function_b22de10a(trigger, team) {
    useobj = gameobjects::create_use_object(team, trigger, [], (0, 0, trigger.height * 0.5), function_18bf10c7(team));
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xd4e48984, Offset: 0x2b70
// Size: 0x14
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x6945862f, Offset: 0x2b90
// Size: 0x3e4
function function_3d1ee3cc(player) {
    ...
    level thread popups::displayteammessagetoteam(#"hash_39ff97d8d8a9a4cd", player, team, undefined, undefined);
    level thread popups::displayteammessagetoteam(#"hash_39ff97d8d8a9a4cd", player, otherteam, undefined, undefined);
    ...
    bb::function_9cca214a("ball_capture", undefined, team, player.origin);
    player recordgameevent("capture");
    player challenges::capturedobjective(gettime(), self.trigger);
    player stats::function_2dabbec7(#"carries", 1);
    player stats::function_2dabbec7(#"captures", 1);
    scoreevents::processscoreevent(#"hash_4d69456db152f5a5", player, undefined, undefined);
    ball_give_score(otherteam, level.carryscore);
}

// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x5191d68c, Offset: 0x2f80
// Size: 0x350
function function_dbf94d16(trigger) {
    ...
    var_afffeadd = gameobjects::create_carry_object(#"neutral", trigger, visuals, (0, 0, 0), #"ball_ball", "mpl_hit_alert_ballholder");
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x84984638, Offset: 0x32d8
// Size: 0x37e
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x5c1015ec, Offset: 0x3660
// Size: 0x16e
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x6fda4440, Offset: 0x37d8
// Size: 0x4dc
function function_6ce143ff(player) {
    ...
    if (pass) {
        if (self.lastcarrierteam == player.team) {
            ...
            scoreevents::processscoreevent(#"hash_7fc37e28bad8da01", player, undefined, undefined);
        }
    }
    ...
    level thread popups::displayteammessagetoteam(#"hash_4b9c97939caa2b83", player, player.team, undefined, undefined);
    level thread popups::displayteammessagetoteam(#"hash_4b9c97939caa2b83", player, otherteam, undefined, undefined);
    ...
    player.balldropdelay = getdvarint(#"hash_104043b1855e0edb", 10);
    player.objective = 1;
    player.hasperksprintfire = player hasperk(#"specialty_sprintfire");
    player perks::perk_setperk("specialty_sprintfire");
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xd5755dc8, Offset: 0x3cc0
// Size: 0x14e
function ball_carrier_cleanup() {
    ...
    if (isdefined(self.carrier)) {
        ...
        self.carrier notify(#"hash_50baa48224190ab1");
        self.carrier thread armor::unsetlightarmor();
        if (!self.carrier.hasperksprintfire) {
            self.carrier perks::perk_unsetperk("specialty_sprintfire");
        }
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x6ab52f60, Offset: 0x3e18
// Size: 0x250
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xfb12f0a3, Offset: 0x4070
// Size: 0x174
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xcf43bc24, Offset: 0x41f0
// Size: 0x1c
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xc68cf4da, Offset: 0x4218
// Size: 0x1f4
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x27beab70, Offset: 0x4418
// Size: 0x1fe
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x87f43f4f, Offset: 0x4620
// Size: 0x5c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xe2e5ff7e, Offset: 0x4688
// Size: 0x25c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x9d66a3b5, Offset: 0x48f0
// Size: 0x214
function ball_shoot_watch() {
    ...
    self endon(#"death");
    self endon(#"drop_object");
    extra_pitch = getdvarfloat(#"hash_32f162df04597db1", 0);
    force = getdvarfloat(#"hash_3bf51c45d887aa81", 900);
    while (true) {
        waitresult = self waittill(#"weapon_fired");
        if (waitresult.weapon != getweapon("ball")) {
            continue;
        }
        break;
    }
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xde41fc05, Offset: 0x4b10
// Size: 0x21c
function ball_weapon_change_watch() {
    ...
    while (true) {
        ...
        lastweapon = waitresult.last_weapon;
        if (isdefined(weapon) && weapon.gadget_type == 11) {
            break;
        }
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xc07d2d98, Offset: 0x4d38
// Size: 0x6e
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x144f7640, Offset: 0x4db0
// Size: 0x1c
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xa583e3a1, Offset: 0x4dd8
// Size: 0xfc
...
// Namespace ball/ball
// Params 3, eflags: 0x0
// Checksum 0xaf0929d, Offset: 0x4ee0
// Size: 0x7c
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x474273be, Offset: 0x4f68
// Size: 0x1e4
function ball_check_pass_kill_pickup(carryobj) {
    ...
    timer = spawnstruct();
    timer endon(#"hash_2bdac9abebda1a73");
    ...
    waitresult = carryobj.carrier waittill(#"death");
    timer timer_cancel();
    if (!isdefined(waitresult.attacker) || waitresult.attacker != self) {
        return;
    }
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x40973898, Offset: 0x5158
// Size: 0x36
function timer_run(time) {
    self endon(#"hash_21bc609dcf55d28d");
    wait time;
    self notify(#"hash_2bdac9abebda1a73");
}

// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x6e273fbe, Offset: 0x5198
// Size: 0x16
function timer_cancel() {
    self notify(#"hash_21bc609dcf55d28d");
}

// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x29b65ef2, Offset: 0x51b8
// Size: 0xfe
function adjust_for_stance(ball) {
    target = self;
    target endon(#"hash_26d293fe725f742a");
    var_5fe7ebc7 = 0;
...
// Namespace ball/ball
// Params 3, eflags: 0x0
// Checksum 0x34039d86, Offset: 0x52c0
// Size: 0x41c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x1524b882, Offset: 0x56e8
// Size: 0xd0
function ball_on_projectile_death() {
    ...
    ball notify(#"hash_26d293fe725f742a");
}

// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xbb8b3105, Offset: 0x57c0
// Size: 0x62
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xa392612b, Offset: 0x5830
// Size: 0xbc
function ball_on_projectile_hit_client(var_c7e075bf) {
    self endon(#"hash_26d293fe725f742a");
    waitresult = self.projectile waittill(#"projectile_impact_player");
    self.trigger notify(#"trigger", {#activator:waitresult.player});
    self.projectile notify(#"hash_75f1178d8e4da23c");
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xb9af32e7, Offset: 0x58f8
// Size: 0x36
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xc84093df, Offset: 0x5938
// Size: 0x94
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x271ad650, Offset: 0x59d8
// Size: 0xa6
...
// Namespace ball/ball
// Params 2, eflags: 0x0
// Checksum 0x70ad2206, Offset: 0x5a88
// Size: 0x1e
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xc140ee42, Offset: 0x5ab0
// Size: 0xd4
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x25b59642, Offset: 0x5b90
// Size: 0xba
...
// Namespace ball/ball
// Params 2, eflags: 0x0
// Checksum 0x749848e, Offset: 0x5c58
// Size: 0x30c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x6dc12169, Offset: 0x5f70
// Size: 0x118
function function_96acd1aa() {
    ...
    visual = self.visuals[0];
    while (true) {
        var_4fca0920 = isdefined(self.in_goal) && self.in_goal || isdefined(self.isresetting) && self.isresetting;
        if (!var_4fca0920) {
            if (visual oob::istouchinganyoobtrigger() || visual function_b2a406b0() || self gameobjects::should_be_reset(visual.origin[2], visual.origin[2] + 10)) {
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x5f20ee93, Offset: 0x6090
// Size: 0x11c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xd2180d3f, Offset: 0x61b8
// Size: 0x88
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xdc3d730b, Offset: 0x6248
// Size: 0x180
...
// Namespace ball/ball
// Params 4, eflags: 0x0
// Checksum 0x88f47916, Offset: 0x63d0
// Size: 0xca
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xad93ae40, Offset: 0x64a8
// Size: 0x3c4
function ball_touched_goal(goal) {
    ...
    if (isdefined(self.lastcarrier)) {
        level thread popups::displayteammessagetoteam(#"hash_39ff97d8d8a9a4cd", self.lastcarrier, team, undefined, undefined);
        level thread popups::displayteammessagetoteam(#"hash_39ff97d8d8a9a4cd", self.lastcarrier, otherteam, undefined, undefined);
        ...
        bb::function_9cca214a("ball_throw", undefined, team, self.lastcarrier.origin);
        self.lastcarrier recordgameevent("throw");
        self.lastcarrier stats::function_2dabbec7(#"throws", 1);
        scoreevents::processscoreevent(#"hash_68634aca4e3c1ae6", self.lastcarrier, undefined, undefined);
        ...
        self.lastcarrier stats::function_2dabbec7(#"captures", 1);
    }
    if (isdefined(self.killcament)) {
...
// Namespace ball/ball
// Params 2, eflags: 0x0
// Checksum 0x95321578, Offset: 0x6878
// Size: 0xea
function ball_give_score(team, score) {
    ...
    if (overtime::is_overtime_round()) {
        ...
        if (game.overtime_first_winner === team) {
            round::set_winner(team);
            thread globallogic::end_round(2);
        }
...
// Namespace ball/ball
// Params 2, eflags: 0x0
// Checksum 0xb54acb23, Offset: 0x6970
// Size: 0x72
...
// Namespace ball/ball
// Params 2, eflags: 0x0
// Checksum 0xc8117f78, Offset: 0x69f0
// Size: 0x8c
function ball_check_assist(player, var_84a3cadc) {
    ...
    scoreevents::processscoreevent(#"hash_7ad353dbba2f7dd9", player.passplayer, undefined, undefined);
}

// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x448650cb, Offset: 0x6a88
// Size: 0xfc
function ball_physics_timeout() {
    ...
    if (isdefined(self.projectile)) {
        var_2615ab42 = self.projectile waittilltimeout(var_394347f7, #"stationary");
        if (!isdefined(var_2615ab42)) {
            return;
        }
        if (var_2615ab42._notify == "stationary") {
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x50633106, Offset: 0x6b90
// Size: 0x64
function ball_physics_out_of_level() {
    self endon(#"reset");
    self endon(#"pickup_object");
    ball = self.visuals[0];
    self waittill(#"hash_5829091f4e894fdd");
    self function_98827162();
}

// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xacee469f, Offset: 0x6c00
// Size: 0x356
function player_update_pass_target(var_afffeadd) {
    self notify(#"hash_24f54127bdf7334");
    self endon(#"hash_24f54127bdf7334");
    self endon(#"disconnect");
    self endon(#"hash_50baa48224190ab1");
    test_dot = 0.8;
    while (true) {
        ...
        if (!self isonladder()) {
            ...
            foreach (target in level.players) {
                ...
                if (!var_afffeadd gameobjects::can_interact_with(target)) {
                    continue;
                }
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x6de6380a, Offset: 0x6f60
// Size: 0xa8
...
// Namespace ball/ball
// Params 2, eflags: 0x0
// Checksum 0xd9eb45e7, Offset: 0x7010
// Size: 0x2c
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x2c3165cb, Offset: 0x7048
// Size: 0x18c
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x764ee1c0, Offset: 0x71e0
// Size: 0xfc
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x518ae49a, Offset: 0x72e8
// Size: 0x206
function function_5fa54274(var_c713c3d7) {
    ...
    var_69e0d43d = getnodesinradius(default_start, 200, 20, 50);
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0x5255c9df, Offset: 0x74f8
// Size: 0xa6
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xb6e976c1, Offset: 0x75a8
// Size: 0xd0
...
// Namespace ball/ball
// Params 1, eflags: 0x0
// Checksum 0xd84315d, Offset: 0x7680
// Size: 0x5c
function function_edcdea6d(team) {
    switch (team) {
    case #"allies":
        return "ball_score_allies";
    case #"axis":
        return "ball_score_axis";
    }
    return undefined;
}
...
// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0xbd914bad, Offset: 0x76e8
// Size: 0x5c
function function_85e74fc9() {
    key = function_edcdea6d(self.team);
    level clientfield::set(key, !level clientfield::get(key));
}

// Namespace ball/ball
// Params 0, eflags: 0x0
// Checksum 0x3e8f79f8, Offset: 0x7750
// Size: 0x1c0
