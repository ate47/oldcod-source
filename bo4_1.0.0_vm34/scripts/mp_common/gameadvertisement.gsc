...
// Params 0, eflags: 0x0
// Checksum 0xe0db40b, Offset: 0x88
// Size: 0x11c
function init() {
    /#
    ...
    if (!isdefined(level.var_3c16bcb)) {
        level.var_3c16bcb = &default_rules;
    }
...
// Namespace gameadvertisement/gameadvertisement
// Params 1, eflags: 0x0
// Checksum 0x120e36eb, Offset: 0x1b0
// Size: 0x34
...
// Namespace gameadvertisement/gameadvertisement
// Params 0, eflags: 0x0
// Checksum 0x8b68599a, Offset: 0x1f0
// Size: 0x128
...
// Namespace gameadvertisement/gameadvertisement
// Params 2, eflags: 0x0
// Checksum 0x325e90df, Offset: 0x320
// Size: 0x1aa
    ...
    if (scorelimit) {
        ...
        foreach (team, _ in level.teams) {
            ...
            if (rulescorepercent >= scorepercentageleft) {
                /#
                    debug_count = updatedebughud(debug_count, "<dev string:x4e>", int(scorepercentageleft));
                #/
                return false;
            }
        }
        /#
            debug_count = updatedebughud(debug_count, "<dev string:x4e>", int(minscorepercentageleft));
        #/
    }
    return true;
}
...
// Namespace gameadvertisement/gameadvertisement
// Params 1, eflags: 0x0
// Checksum 0x18f5f221, Offset: 0x4d8
// Size: 0x64
...
// Namespace gameadvertisement/gameadvertisement
// Params 0, eflags: 0x0
// Checksum 0xff56e0b4, Offset: 0x548
// Size: 0x402
function default_rules() {
    ...
    if (level.gameadvertisementrulescorepercent) {
        /#
            debug_count = updatedebughud(debug_count, "<dev string:x66>", level.gameadvertisementrulescorepercent);
        #/
        if (level.teambased) {
    ...
    if (level.gameadvertisementruletimeleft && currentround >= level.gameadvertisementruleround - 1) {
        /#
            debug_count = updatedebughud(debug_count, "<dev string:x97>", level.gameadvertisementruletimeleft / 60000);
        #/
    ...
    if (level.gameadvertisementruleround) {
        /#
            debug_count = updatedebughud(debug_count, "<dev string:xc4>", level.gameadvertisementruleround);
            debug_count = updatedebughud(debug_count, "<dev string:xcf>", currentround);
        #/
    ...
    if (level.gameadvertisementruleroundswon) {
        /#
            debug_count = updatedebughud(debug_count, "<dev string:xdf>", level.gameadvertisementruleroundswon);
        #/
        maxroundswon = 0;
        foreach (team, _ in level.teams) {
            ...
            if (level.gameadvertisementruleroundswon <= roundswon) {
                /#
                    debug_count = updatedebughud(debug_count, "<dev string:xf9>", maxroundswon);
                #/
                return false;
            }
        }
...
/#
    ...
    // Namespace gameadvertisement/gameadvertisement
    // Params 2, eflags: 0x0
    // Checksum 0x377bb9f8, Offset: 0x958
    // Size: 0x152
    function sessionadvertismentcreatedebughud(linenum, alignx) {
        debug_hud = dev::new_hud("<dev string:x10a>", "<dev string:x119>", 0, 0, 1);
        debug_hud.hidewheninmenu = 1;
        debug_hud.horzalign = "<dev string:x123>";
        debug_hud.vertalign = "<dev string:x129>";
        debug_hud.alignx = "<dev string:x123>";
        debug_hud.aligny = "<dev string:x129>";
        debug_hud.x = alignx;
        debug_hud.y = -50 + linenum * 15;
        debug_hud.foreground = 1;
        debug_hud.font = "<dev string:x130>";
        debug_hud.fontscale = 1.5;
        debug_hud.color = (1, 1, 1);
        debug_hud.alpha = 1;
        debug_hud settext("<dev string:x138>");
        return debug_hud;
    }

    // Namespace gameadvertisement/gameadvertisement
    // Params 3, eflags: 0x0
    // Checksum 0xd515cbd2, Offset: 0xab8
    // Size: 0x10e
    ...
    // Namespace gameadvertisement/gameadvertisement
    // Params 0, eflags: 0x0
    // Checksum 0xd998944b, Offset: 0xbd0
    // Size: 0x660
    function sessionadvertismentupdatedebughud() {
        ...
        level.sessionadverthud_0_text = "<dev string:x138>";
        level.sessionadverthud_1a_text = "<dev string:x138>";
        level.sessionadverthud_1b_text = "<dev string:x138>";
        level.sessionadverthud_2a_text = "<dev string:x138>";
        level.sessionadverthud_2b_text = "<dev string:x138>";
        level.sessionadverthud_3a_text = "<dev string:x138>";
        level.sessionadverthud_3b_text = "<dev string:x138>";
        level.sessionadverthud_4a_text = "<dev string:x138>";
        level.sessionadverthud_4b_text = "<dev string:x138>";
        while (true) {
            wait 1;
            showdebughud = getdvarint(#"sessionadvertshowdebughud", 0);
            level.sessionadverthud_0_text = "<dev string:x139>";
