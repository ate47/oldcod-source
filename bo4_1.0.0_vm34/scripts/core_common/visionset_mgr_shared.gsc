...
// Params 0, eflags: 0x2
// Checksum 0xf0687ea8, Offset: 0xc0
// Size: 0x3c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0x2ffaed3e, Offset: 0x108
// Size: 0xc4
function __init__() {
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 8, eflags: 0x0
// Checksum 0x41b28a42, Offset: 0x1d8
// Size: 0x196
function register_info(type, name, version, priority, lerp_step_count, should_activate_per_player, lerp_thread, ref_count_lerp_thread) {
    assert(level.vsmgr_initializing, "<dev string:x30>");
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 6, eflags: 0x0
// Checksum 0xa5b1137e, Offset: 0x378
// Size: 0x18e
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 3, eflags: 0x0
// Checksum 0xe184983f, Offset: 0x510
// Size: 0x138
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 2, eflags: 0x0
// Checksum 0xbe20ad4, Offset: 0x650
// Size: 0x92
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 1, eflags: 0x0
// Checksum 0x6da5c9, Offset: 0x6f0
// Size: 0x86
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 3, eflags: 0x0
// Checksum 0xb5573aa8, Offset: 0x780
// Size: 0xa4
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 4, eflags: 0x0
// Checksum 0x865d16f9, Offset: 0x830
// Size: 0x6c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 2, eflags: 0x0
// Checksum 0x95d8d163, Offset: 0x8a8
// Size: 0x154
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 3, eflags: 0x0
// Checksum 0xc4ac6de, Offset: 0xa08
// Size: 0x114
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 2, eflags: 0x0
// Checksum 0x4ed887e3, Offset: 0xb28
// Size: 0xb6
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0x3fee8a5f, Offset: 0xbe8
// Size: 0x80
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 3, eflags: 0x0
// Checksum 0x3048e370, Offset: 0xc70
// Size: 0x24c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 4, eflags: 0x0
// Checksum 0xd09b4ed0, Offset: 0xec8
// Size: 0x1c4
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 1, eflags: 0x0
// Checksum 0x8246296b, Offset: 0x1098
// Size: 0xa4
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 4, eflags: 0x0
// Checksum 0x2d36e260, Offset: 0x1148
// Size: 0x6c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 4, eflags: 0x0
// Checksum 0xe0a779d2, Offset: 0x11c0
// Size: 0x44
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 1, eflags: 0x0
// Checksum 0xad9ab959, Offset: 0x1210
// Size: 0x154
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0x94180400, Offset: 0x1370
// Size: 0x8e
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0xbd01094, Offset: 0x1408
// Size: 0x23c
function finalize_type_clientfields() {
    println("<dev string:xa5>" + self.type + "<dev string:xb5>");
    if (1 >= self.info.size) {
        return;
    }
    self.in_use = 1;
    ...
    for (i = 0; i < self.sorted_name_keys.size; i++) {
        ...
        println("<dev string:xcd>" + self.info[self.sorted_name_keys[i]].name + "<dev string:xd8>" + self.info[self.sorted_name_keys[i]].version + "<dev string:xe4>" + self.info[self.sorted_name_keys[i]].lerp_step_count + "<dev string:xf8>");
    }
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 3, eflags: 0x0
// Checksum 0x75c1a926, Offset: 0x1650
// Size: 0x1e0
function validate_info(type, name, priority) {
    ...
    assert(i < keys.size, "<dev string:xf9>" + type + "<dev string:x112>");
    foreach (v in level.vsmgr[type].info) {
        assert(v.name != name, "<dev string:x11e>" + type + "<dev string:x139>" + name + "<dev string:x143>");
        assert(v.priority != priority, "<dev string:x11e>" + type + "<dev string:x164>" + priority + "<dev string:x172>" + name + "<dev string:x189>" + v.name + "<dev string:x1b7>");
    }
}

// Namespace visionset_mgr/visionset_mgr_shared
// Params 2, eflags: 0x0
// Checksum 0xcba5de6a, Offset: 0x1838
// Size: 0x9c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 3, eflags: 0x0
// Checksum 0x228257ea, Offset: 0x18e0
// Size: 0xc4
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 8, eflags: 0x0
// Checksum 0x8206b37a, Offset: 0x19b0
// Size: 0x15a
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0x25d6b806, Offset: 0x1b18
// Size: 0x1c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0x94b31648, Offset: 0x1b40
// Size: 0x238
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0xb5806794, Offset: 0x1d80
// Size: 0x11c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 0, eflags: 0x0
// Checksum 0x141f7eba, Offset: 0x1ea8
// Size: 0x140
function monitor() {
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 1, eflags: 0x0
// Checksum 0x75c58f21, Offset: 0x1ff0
// Size: 0xa6
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 2, eflags: 0x0
// Checksum 0x3fc6ac2a, Offset: 0x20a0
// Size: 0xd4
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 4, eflags: 0x0
// Checksum 0x26abdb73, Offset: 0x2180
// Size: 0x60
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 5, eflags: 0x0
// Checksum 0x691b2ba1, Offset: 0x21e8
// Size: 0xbe
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 6, eflags: 0x0
// Checksum 0xe42a0c1b, Offset: 0x22b0
// Size: 0x12c
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 3, eflags: 0x0
// Checksum 0x51a7ef45, Offset: 0x23e8
// Size: 0x106
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 2, eflags: 0x0
// Checksum 0xe4422610, Offset: 0x24f8
// Size: 0x92
...
// Namespace visionset_mgr/visionset_mgr_shared
// Params 2, eflags: 0x0
// Checksum 0x25f0616f, Offset: 0x2598
// Size: 0x92
