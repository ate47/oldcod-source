...
/#
    ...
    // Params 0, eflags: 0x2
    // Checksum 0xd4134ce1, Offset: 0x70
    // Size: 0x3c
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0x6448950e, Offset: 0xb8
    // Size: 0x1c
    function __init__() {
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0x544e030d, Offset: 0xe0
    // Size: 0x56
    function debugdvars() {
        while (true) {
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0xae103aac, Offset: 0x140
    // Size: 0x58
    function isdebugon() {
    ...
    // Namespace as_debug/debug
    // Params 4, eflags: 0x0
    // Checksum 0xef2f5e1a, Offset: 0x1a0
    // Size: 0x6c
    ...
    // Namespace as_debug/debug
    // Params 4, eflags: 0x0
    // Checksum 0x6df3fc7a, Offset: 0x218
    // Size: 0x5c
    ...
    // Namespace as_debug/debug
    // Params 4, eflags: 0x0
    // Checksum 0xc95ee3ea, Offset: 0x280
    // Size: 0x74
    ...
    // Namespace as_debug/debug
    // Params 4, eflags: 0x0
    // Checksum 0xbaf2c545, Offset: 0x300
    // Size: 0x144
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0x97e4102d, Offset: 0x450
    // Size: 0xa6
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0xb6e8ef24, Offset: 0x500
    // Size: 0x116
    ...
    // Namespace as_debug/debug
    // Params 4, eflags: 0x0
    // Checksum 0x9c777e07, Offset: 0x620
    // Size: 0x134
    ...
    // Namespace as_debug/debug
    // Params 2, eflags: 0x0
    // Checksum 0x39b60796, Offset: 0x760
    // Size: 0x196
    function debugpushstate(statename, extrainfo) {
        ...
        if (isdefined(extrainfo)) {
            state.extrainfo = extrainfo + "<dev string:x30>";
        }
    ...
    // Namespace as_debug/debug
    // Params 2, eflags: 0x0
    // Checksum 0x1aad820f, Offset: 0x900
    // Size: 0x2e6
    function debugaddstateinfo(statename, extrainfo) {
            ...
            for (i = self.debuginfo.states.size - 1; i >= 0; i--) {
                ...
                if (self.debuginfo.states[i].statename == statename) {
                    if (!isdefined(self.debuginfo.states[i].extrainfo)) {
                        self.debuginfo.states[i].extrainfo = "<dev string:x32>";
                    }
                    self.debuginfo.states[i].extrainfo = self.debuginfo.states[i].extrainfo + extrainfo + "<dev string:x30>";
                    break;
                }
            }
            return;
        ...
        if (self.debuginfo.states.size > 0) {
            ...
            if (!isdefined(self.debuginfo.states[lastindex].extrainfo)) {
                self.debuginfo.states[lastindex].extrainfo = "<dev string:x32>";
            }
            self.debuginfo.states[lastindex].extrainfo = self.debuginfo.states[lastindex].extrainfo + extrainfo + "<dev string:x30>";
        }
    }

    // Namespace as_debug/debug
    // Params 2, eflags: 0x0
    // Checksum 0x14cbfb02, Offset: 0xbf0
    // Size: 0x342
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0x73081d02, Offset: 0xf40
    // Size: 0x3a
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0x6406d6c2, Offset: 0xf88
    // Size: 0x4a
    ...
    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0x5dff3029, Offset: 0xfe0
    // Size: 0x9a
    ...
    // Namespace as_debug/debug
    // Params 1, eflags: 0x0
    // Checksum 0x570c00b, Offset: 0x1088
    // Size: 0x5c
    function indent(depth) {
        indent = "<dev string:x32>";
        for (i = 0; i < depth; i++) {
            indent += "<dev string:x30>";
        }
        return indent;
    }
    ...
    // Namespace as_debug/debug
    // Params 3, eflags: 0x0
    // Checksum 0xc363b62c, Offset: 0x10f0
    // Size: 0xee
    ...
    // Namespace as_debug/debug
    // Params 5, eflags: 0x0
    // Checksum 0x382edc0e, Offset: 0x11e8
    // Size: 0x15c
    function debugdrawweightedpoint(entity, point, weight, lowestvalue, highestvalue) {
        ...
        if (weight <= midvalue) {
            ...
            recordcircle(point, 2, (redcolor, 0, 0), "<dev string:x33>", entity);
            return;
        }
        greencolor = 1 - abs((highestvalue - weight) / halfdeltavalue);
        recordcircle(point, 2, (0, greencolor, 0), "<dev string:x33>", entity);
    }

    // Namespace as_debug/debug
    // Params 0, eflags: 0x0
    // Checksum 0x4782e186, Offset: 0x1350
    // Size: 0xd0
