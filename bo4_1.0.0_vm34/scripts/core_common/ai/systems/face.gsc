...
// Namespace face/face
// Params 1, eflags: 0x0
// Checksum 0xa8ac966d, Offset: 0xe8
// Size: 0x144
function saygenericdialogue(typestring) {
    ...
    case #"pain_bullet":
        ...
        break;
    default:
        println("<dev string:x30>" + typestring);
        importance = 0.3;
        break;
    }
...
// Namespace face/face
// Params 2, eflags: 0x0
// Checksum 0xbe2cc446, Offset: 0x238
// Size: 0xb4
...
// Namespace face/face
// Params 1, eflags: 0x0
// Checksum 0xe67c80a1, Offset: 0x2f8
// Size: 0x1e
...
// Namespace face/face
// Params 1, eflags: 0x0
// Checksum 0xa3a4aa48, Offset: 0x320
// Size: 0x44
...
// Namespace face/face
// Params 7, eflags: 0x0
// Checksum 0xe258ca66, Offset: 0x370
// Size: 0x6c
...
// Namespace face/face
// Params 0, eflags: 0x0
// Checksum 0xb620a197, Offset: 0x3e8
// Size: 0x4
...
// Namespace face/face
// Params 7, eflags: 0x0
// Checksum 0x466b06c2, Offset: 0x3f8
// Size: 0x6fe
function playfacethread(facialanim, str_script_alias, importance, notifystring, waitornot, timetowait, player_or_team) {
    ...
    if (self.istalking) {
        if (isdefined(self.a.currentdialogimportance)) {
            if (importance < self.a.currentdialogimportance) {
                ...
                println("<dev string:x7b>" + self.a.facialsoundalias + "<dev string:x94>" + str_script_alias);
                while (self.istalking) {
                    self waittill(#"done speaking");
                }
            }
        } else {
            println("<dev string:x9e>" + self.a.facialsoundalias + "<dev string:x94>" + str_script_alias);
    ...
    /#
        if (level.numberofimportantpeopletalking > 1) {
            println("<dev string:xbb>" + str_script_alias);
        }
    #/
    ...
    if (isdefined(str_vox_file)) {
        if (soundexists(str_vox_file)) {
            ...
            /#
                println("<dev string:xfa>" + str_script_alias + "<dev string:x116>");
...
// Namespace face/face
// Params 3, eflags: 0x0
// Checksum 0x6f76d10d, Offset: 0xb00
// Size: 0xfc
...
// Namespace face/face
// Params 3, eflags: 0x4
// Checksum 0xae08f86, Offset: 0xc08
// Size: 0x33c
...
// Namespace face/face
// Params 3, eflags: 0x4
// Checksum 0xf94538ac, Offset: 0xf50
// Size: 0x54
...
// Namespace face/face
// Params 3, eflags: 0x0
// Checksum 0x377a7895, Offset: 0xfb0
// Size: 0x66
...
// Namespace face/face
// Params 3, eflags: 0x0
// Checksum 0x479a29c0, Offset: 0x1020
// Size: 0x5e
