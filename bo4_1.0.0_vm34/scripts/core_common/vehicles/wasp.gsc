...
// Namespace wasp/wasp
// Params 0, eflags: 0x2
// Checksum 0xa8fc6faf, Offset: 0x238
// Size: 0x3c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x1593c5dc, Offset: 0x280
// Size: 0x74
function __init__() {
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0xd5fbce7, Offset: 0x300
// Size: 0x284
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x3fb64a35, Offset: 0x590
// Size: 0x2d4
function defaultrole() {
    ...
    if (ispathfinder(self)) {
        ...
        self vehicle_ai::get_state_callbacks("combat").update_func = &function_37a99b6c;
        self vehicle_ai::get_state_callbacks("death").update_func = &state_death_update;
    }
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0xb7c2b0a0, Offset: 0x870
// Size: 0x3ac
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x8c0ff5ad, Offset: 0xc28
// Size: 0x66c
function state_emped_update(params) {
    ...
    if (isdefined(self.position_before_fall)) {
        ...
        if (isdefined(goalpoint) && sighttracepassed(self.origin + originoffset, goalpoint, 0, self)) {
            self function_3c8dce03(goalpoint, 0, 0);
            ...
            foundgoal = self function_3c8dce03(self.current_pathto_pos, 1, 1);
            ...
            if (foundgoal) {
                ...
                self function_3c8dce03(self.origin, 1, 0);
            }
            wait 1;
    ...
    self vehicle::lights_off();
    self thread function_e9c8df03();
}

// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0xc6768446, Offset: 0x12a0
// Size: 0x4c
function function_e9c8df03() {
    self notify("31da9b3f2e8d0c47");
    self endon("31da9b3f2e8d0c47");
    self endon(#"death");
    wait 3;
    self kill();
}
...
// Namespace wasp/wasp
// Params 3, eflags: 0x0
// Checksum 0x4d4acf16, Offset: 0x12f8
// Size: 0x5a6
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x472752b7, Offset: 0x18a8
// Size: 0x266
...
/#
    ...
    // Namespace wasp/wasp
    // Params 0, eflags: 0x0
    // Checksum 0x939be438, Offset: 0x1b18
    // Size: 0x102
    function guard_points_debug() {
        ...
        while (true) {
            foreach (point in self.debugpointsarray) {
                color = (1, 0, 0);
                if (ispointinnavvolume(point, "<dev string:x30>")) {
                    color = (0, 1, 0);
                }
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x9857bc87, Offset: 0x1c28
// Size: 0x330
function get_guard_points(owner) {
    assert(self._guard_points.size > 0, "<dev string:x40>");
    points_array = [];
...
// Namespace wasp/wasp
// Params 3, eflags: 0x0
// Checksum 0xa6910e52, Offset: 0x1f60
// Size: 0x126
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x27aece1, Offset: 0x2090
// Size: 0x4c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0xa0d024a0, Offset: 0x20e8
// Size: 0x72
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x1ec935ec, Offset: 0x2168
// Size: 0x3e
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x2db90760, Offset: 0x21b0
// Size: 0x64
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x2e9f2a6e, Offset: 0x2220
// Size: 0xd4
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x930b9f93, Offset: 0x2300
// Size: 0x848
function state_guard_update(params) {
    ...
    while (true) {
        ...
        if (!onnavvolume) {
            ...
            if (isdefined(getbackpoint)) {
                ...
                if (stuckcount == 1) {
                    ...
                    /#
                        assert(0, "<dev string:x59>" + self.origin);
        ...
        if (isdefined(self.current_pathto_pos)) {
            ...
            if (self function_3c8dce03(self.current_pathto_pos, 1, usepathfinding)) {
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0xebcdd09e, Offset: 0x2b50
// Size: 0x84
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x6d08b685, Offset: 0x2be0
// Size: 0x53c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x7f0d2608, Offset: 0x3128
// Size: 0x23c
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x569136a, Offset: 0x3370
// Size: 0x2b8
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0xe0dd9a7c, Offset: 0x3630
// Size: 0x3e
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0xd99db594, Offset: 0x3678
// Size: 0x1de
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0x2668bcfc, Offset: 0x3860
// Size: 0x140
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0xb4688e57, Offset: 0x39a8
// Size: 0x134
function function_37a99b6c(params) {
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0xbc43f73c, Offset: 0x3ae8
// Size: 0x842
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x82aa8e13, Offset: 0x4338
// Size: 0x2e2
function getnextmoveposition_wander() {
    ...
    foreach (point in queryresult.data) {
        ...
        /#
            ...
            point._scoredebug[#"disttoorigin"].scorename = "<dev string:x7c>";
        #/
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x4668e4f7, Offset: 0x4628
// Size: 0x107e
function getnextmoveposition_tactical() {
                ...
                foreach (point in queryresult.data) {
                    if (point.visowner === 1) {
                        /#
                            ...
                            point._scoredebug[#"visowner"].scorename = "<dev string:x89>";
                        #/
                        point.score += 300;
                    }
                    if (point.visenemy === 1) {
                        /#
                            ...
                            point._scoredebug[#"visenemy"].scorename = "<dev string:x92>";
                        #/
                        point.score += 300;
                    }
                }
    ...
    foreach (point in queryresult.data) {
        /#
            ...
            point._scoredebug[#"random"].scorename = "<dev string:x9b>";
        #/
        ...
        /#
            ...
            point._scoredebug[#"engagementdist"].scorename = "<dev string:xa2>";
        #/
        ...
        /#
            ...
            point._scoredebug[#"height"].scorename = "<dev string:xb1>";
        #/
        ...
        if (point.disttoorigin2d < 120) {
            /#
                ...
                point._scoredebug[#"tooclosetoself"].scorename = "<dev string:xb8>";
            #/
        ...
        foreach (location in avoid_locations) {
            if (distancesquared(point.origin, location) < avoid_radius * avoid_radius) {
                /#
                    ...
                    point._scoredebug[#"tooclosetoothers"].scorename = "<dev string:xc7>";
                #/
        ...
        if (point.inclaimedlocation) {
            /#
                ...
                point._scoredebug[#"inclaimedlocation"].scorename = "<dev string:xd8>";
            #/
            point.score += -500;
        }
        if (point.score > best_score) {
...
// Checksum 0x7fa05b06, Offset: 0x56b0
// Size: 0xd2
...
// Namespace wasp/wasp
// Params 4, eflags: 0x0
// Checksum 0x9868a9, Offset: 0x5790
// Size: 0x7e
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0xa5dc79d, Offset: 0x5818
// Size: 0xb4
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0xed73e01, Offset: 0x58d8
// Size: 0x82
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x3b48a5ce, Offset: 0x5968
// Size: 0x150
...
// Namespace wasp/wasp
// Params 2, eflags: 0x0
// Checksum 0x739d3840, Offset: 0x5ac0
// Size: 0x100
...
// Namespace wasp/wasp
// Params 2, eflags: 0x4
// Checksum 0x3d375c8, Offset: 0x5bc8
// Size: 0x14e
function private _wasp_tower_init(wasp_tower, n_spawn_count) {
    ...
    foreach (s_fxanim in wasp_tower.a_fxanims) {
        scene::add_scene_func(s_fxanim.scriptbundlename, &function_39ea1a59, "done");
        s_fxanim scene::init();
    }
...
// Namespace wasp/wasp
// Params 2, eflags: 0x4
// Checksum 0xbc340b38, Offset: 0x5d20
// Size: 0x156
...
// Namespace wasp/wasp
// Params 2, eflags: 0x0
// Checksum 0x51ef6ed5, Offset: 0x5e80
// Size: 0xf0
...
// Namespace wasp/wasp
// Params 1, eflags: 0x4
// Checksum 0xa15a6419, Offset: 0x5f78
// Size: 0x1b8
function private _wasp_tower_launch(wasp_tower) {
    ...
    foreach (s_fxanim in wasp_tower.a_fxanims) {
        ...
        wait n_delay;
        a_wasps = wasp_tower_spawn(wasp_tower, wasp_tower.var_68c7edc0);
        if (a_wasps.size) {
...
// Namespace wasp/wasp
// Params 1, eflags: 0x0
// Checksum 0xdb4a6a1a, Offset: 0x6138
// Size: 0xca
function function_39ea1a59(a_ents) {
...
// Namespace wasp/wasp
// Params 0, eflags: 0x4
// Checksum 0x3b4c71ed, Offset: 0x6210
// Size: 0x9c
...
// Namespace wasp/wasp
// Params 0, eflags: 0x0
// Checksum 0x65fce92b, Offset: 0x62b8
// Size: 0x58
...
// Namespace wasp/wasp
// Params 2, eflags: 0x0
// Checksum 0x8f3485ec, Offset: 0x6318
// Size: 0x278
