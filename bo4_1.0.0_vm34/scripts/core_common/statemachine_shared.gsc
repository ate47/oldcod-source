...
// Params 3, eflags: 0x0
// Checksum 0x334f794d, Offset: 0x78
// Size: 0x140
function create(name, owner, change_notify = "change_state") {
    ...
    /#
        owner thread function_b9384ac7();
    #/
...
// Namespace statemachine/statemachine_shared
// Params 0, eflags: 0x0
// Checksum 0x8cf90c3c, Offset: 0x1c0
// Size: 0xde
function clear() {
...
// Namespace statemachine/statemachine_shared
// Params 5, eflags: 0x0
// Checksum 0xa5cb2d4f, Offset: 0x2a8
// Size: 0x144
...
// Namespace statemachine/statemachine_shared
// Params 1, eflags: 0x0
// Checksum 0xeb5560a3, Offset: 0x3f8
// Size: 0x18
...
// Namespace statemachine/statemachine_shared
// Params 1, eflags: 0x0
// Checksum 0xefbb4c01, Offset: 0x418
// Size: 0x28
...
// Namespace statemachine/statemachine_shared
// Params 4, eflags: 0x0
// Checksum 0x71500194, Offset: 0x448
// Size: 0xfc
...
// Namespace statemachine/statemachine_shared
// Params 4, eflags: 0x0
// Checksum 0x6283807, Offset: 0x550
// Size: 0x190
...
// Namespace statemachine/statemachine_shared
// Params 2, eflags: 0x0
// Checksum 0x97b02ce0, Offset: 0x6e8
// Size: 0x5c
...
// Namespace statemachine/statemachine_shared
// Params 2, eflags: 0x0
// Checksum 0xcdfd71d0, Offset: 0x750
// Size: 0x280
function set_state(name, state_params) {
    ...
    if (!isdefined(state)) {
        assertmsg("<dev string:x30>" + name + "<dev string:x4c>" + self.name);
        return false;
    }
...
// Namespace statemachine/statemachine_shared
// Params 1, eflags: 0x0
// Checksum 0xcd774084, Offset: 0x9d8
// Size: 0xd0
...
// Namespace statemachine/statemachine_shared
// Params 3, eflags: 0x0
// Checksum 0x4439318e, Offset: 0xab0
// Size: 0xf8
...
// Namespace statemachine/statemachine_shared
// Params 2, eflags: 0x0
// Checksum 0xfafc7d84, Offset: 0xbb0
// Size: 0x2a4
...
/#
    ...
    // Namespace statemachine/statemachine_shared
    // Params 0, eflags: 0x0
    // Checksum 0xe38ea5a, Offset: 0xe60
    // Size: 0x40
    function debugon() {
    ...
    // Namespace statemachine/statemachine_shared
    // Params 0, eflags: 0x0
    // Checksum 0x4534229d, Offset: 0xea8
    // Size: 0x270
    function function_b9384ac7() {
        owner = self;
        if (!isdefined(owner)) {
            return;
        }
        ...
        while (true) {
            ...
            foreach (state_machine in owner.state_machines) {
                ...
                if (!getdvarint(#"recorder_enablerec", 0)) {
                    ...
                    print3d(owner.origin + (0, 0, heightoffset), "<dev string:x68>" + state_machine.name + "<dev string:x6d>" + statename, (1, 1, 0));
                } else {
                    record3dtext("<dev string:x68>" + state_machine.name + "<dev string:x6d>" + statename, owner.origin, (1, 1, 0), "<dev string:x70>", owner, 1);
                }
                i++;
            }
            waitframe(1);
