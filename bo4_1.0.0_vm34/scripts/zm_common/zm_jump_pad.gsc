...
// Params 0, eflags: 0x2
// Checksum 0x90cbe3df, Offset: 0xe0
// Size: 0x3c
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 0, eflags: 0x0
// Checksum 0xb31492be, Offset: 0x128
// Size: 0x1c
function __init__() {
    level jump_pad_init();
}
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 0, eflags: 0x0
// Checksum 0x530df37b, Offset: 0x150
// Size: 0x174
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 0, eflags: 0x0
// Checksum 0xb5181d4f, Offset: 0x2d0
// Size: 0x1a
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 0, eflags: 0x0
// Checksum 0x90e15237, Offset: 0x2f8
// Size: 0x1a0
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 1, eflags: 0x0
// Checksum 0x81b7426d, Offset: 0x4a0
// Size: 0x64
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 2, eflags: 0x0
// Checksum 0x29df10f4, Offset: 0x510
// Size: 0xcb4
function jump_pad_start(ent_player, endon_condition) {
    ...
    if (isdefined(self.script_string) && isdefined(level._jump_pad_override[self.script_string])) {
        ...
        if (z_dist > 40 && z_dist < 135) {
            ...
            /#
                if (getdvarint(#"jump_pad_tweaks", 0)) {
                    if (getdvarstring(#"jump_pad_z_dist") != "<dev string:x30>") {
                        z_dist *= getdvarfloat(#"jump_pad_z_dist", 0);
                    }
                    if (getdvarstring(#"jump_pad_forward") != "<dev string:x30>") {
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 1, eflags: 0x0
// Checksum 0xdd358253, Offset: 0x11d0
// Size: 0xe6
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 4, eflags: 0x0
// Checksum 0xaa3e38d3, Offset: 0x12c0
// Size: 0x494
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 0, eflags: 0x0
// Checksum 0x5f1b1ab8, Offset: 0x1760
// Size: 0xac
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 2, eflags: 0x0
// Checksum 0xb212e550, Offset: 0x1818
// Size: 0x8c
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 1, eflags: 0x0
// Checksum 0x3165a89b, Offset: 0x18b0
// Size: 0x226
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 1, eflags: 0x0
// Checksum 0xa3d00737, Offset: 0x1ae0
// Size: 0xfe
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 1, eflags: 0x0
// Checksum 0x3ffe211b, Offset: 0x1be8
// Size: 0x146
...
// Namespace zm_jump_pad/zm_jump_pad
// Params 2, eflags: 0x0
// Checksum 0xc446fa5c, Offset: 0x1d38
// Size: 0xba
