...
// Params 1, eflags: 0x0
// Checksum 0xd4c1a7d5, Offset: 0x90
// Size: 0xbc
...
// Namespace ability_util/ability_util
// Params 1, eflags: 0x0
// Checksum 0xbefe18cf, Offset: 0x158
// Size: 0x1c
...
// Namespace ability_util/ability_util
// Params 1, eflags: 0x0
// Checksum 0xf4225fd2, Offset: 0x180
// Size: 0xbc
...
// Namespace ability_util/ability_util
// Params 7, eflags: 0x0
// Checksum 0x7000f9f2, Offset: 0x248
// Size: 0x1a4
function update_applied_aoe_fx(local_client_num, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
    ...
    if (newval != oldval) {
        ...
        if (!self function_60dbc438()) {
            if (isdefined(self.var_66572ff5)) {
                stopfx(local_client_num, self.var_66572ff5);
                self.var_66572ff5 = undefined;
            }
            if (newval) {
                self.var_66572ff5 = util::playfxontag(local_client_num, fx_info.fx_3p, self, "j_mainroot");
            }
            return;
        }
        if (newval) {
...
// Namespace ability_util/ability_util
// Params 7, eflags: 0x0
// Checksum 0xd1bd379f, Offset: 0x3f8
// Size: 0x190
function set_aoe_fx(local_client_num, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
    ...
    if (newval) {
        ...
        if (isdefined(aoe_fx_info.var_717c89da)) {
            fx = playfx(local_client_num, aoe_fx_info.var_717c89da, self.origin);
...
// Namespace ability_util/ability_util
// Params 3, eflags: 0x0
// Checksum 0xb5020141, Offset: 0x590
// Size: 0xd8
...
// Namespace ability_util/ability_util
// Params 3, eflags: 0x4
// Checksum 0xd21a8a43, Offset: 0x670
// Size: 0x396
...
// Namespace ability_util/ability_util
// Params 6, eflags: 0x4
// Checksum 0x3a1aefed, Offset: 0xa10
// Size: 0x56c
...
// Namespace ability_util/ability_util
// Params 3, eflags: 0x0
// Checksum 0x4d8458ac, Offset: 0xf88
// Size: 0x80
