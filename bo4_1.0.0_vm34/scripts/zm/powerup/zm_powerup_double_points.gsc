...
// Params 0, eflags: 0x2
// Checksum 0x55b61694, Offset: 0x178
// Size: 0x3c
...
// Namespace zm_powerup_double_points/zm_powerup_double_points
// Params 0, eflags: 0x0
// Checksum 0x2a873308, Offset: 0x1c0
// Size: 0x9c
function __init__() {
...
// Namespace zm_powerup_double_points/zm_powerup_double_points
// Params 1, eflags: 0x0
// Checksum 0xdb14d23d, Offset: 0x268
// Size: 0x8c
function grab_double_points(player) {
    if (zm_powerups::function_ffd24ecc(#"double_points")) {
        level thread function_af2ea54f(self, player);
    } else {
...
// Namespace zm_powerup_double_points/zm_powerup_double_points
// Params 2, eflags: 0x0
// Checksum 0x912bcf7f, Offset: 0x300
// Size: 0x14c
function function_af2ea54f(e_powerup, player) {
    player notify(#"powerup points scaled");
    player endon(#"powerup points scaled", #"disconnect");
    player thread zm_powerups::function_e00ef9d4("double_points");
...
// Namespace zm_powerup_double_points/zm_powerup_double_points
// Params 2, eflags: 0x0
// Checksum 0x1b4ab87f, Offset: 0x458
// Size: 0x28e
