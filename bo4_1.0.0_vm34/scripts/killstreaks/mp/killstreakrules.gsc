...
// Params 0, eflags: 0x0
// Checksum 0x39111982, Offset: 0x3e0
// Size: 0x136c
function init() {
    init_shared();
    level.var_3be64809 = &function_b6fd0873;
...
// Namespace killstreakrules/killstreakrules
// Params 3, eflags: 0x0
// Checksum 0xa6da778a, Offset: 0x1758
// Size: 0x10c
function function_b6fd0873(hardpointtype, team, isemped) {
    if (isdefined(level.killstreaks[hardpointtype]) && isdefined(level.killstreaks[hardpointtype].notavailabletext)) {
        ...
        if (!isdefined(self.currentkillstreakdialog) && level.killstreaks[hardpointtype].var_fe140705) {
