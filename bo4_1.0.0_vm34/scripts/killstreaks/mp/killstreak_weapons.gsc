...
// Params 0, eflags: 0x0
// Checksum 0x16b35ebd, Offset: 0x158
// Size: 0x104
function init() {
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 0, eflags: 0x0
// Checksum 0xc9e79d0, Offset: 0x268
// Size: 0xa4
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 0, eflags: 0x0
// Checksum 0xee195918, Offset: 0x318
// Size: 0x1e8
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 1, eflags: 0x0
// Checksum 0xeed5afac, Offset: 0x508
// Size: 0x7c
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 1, eflags: 0x0
// Checksum 0x1076ce71, Offset: 0x590
// Size: 0x6dc
function usecarriedkillstreakweapon(hardpointtype) {
    ...
    if ((hardpointtype == "minigun" || hardpointtype == "inventory_minigun") && !(isdefined(self.minigunstart) && self.minigunstart) || (hardpointtype == "m32" || hardpointtype == "inventory_m32") && !(isdefined(self.m32start) && self.m32start)) {
        ...
        self stats::function_4f10b697(killstreakweapon, #"used", 1);
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 1, eflags: 0x0
// Checksum 0x5d077aa8, Offset: 0xc78
// Size: 0x16e
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 3, eflags: 0x0
// Checksum 0x78a4eda5, Offset: 0xdf0
// Size: 0x4ec
    ...
    while (true) {
        ...
        if (currentammo == 0 || self.pers[#"killstreak_quantity"][killstreakweapon] > 0 || isfrominventory && isdefined(killstreakid) && killstreakid != killstreak_id) {
            ...
            if (self.pers[#"killstreak_quantity"][killstreakweapon] > 0) {
                ...
                self loadout::function_fae397a1(killstreakweapon, self.pers[#"held_killstreak_ammo_count"][killstreakweapon]);
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 3, eflags: 0x0
// Checksum 0xccf1b264, Offset: 0x12e8
// Size: 0x538
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 1, eflags: 0x0
// Checksum 0x4e16ebd6, Offset: 0x1828
// Size: 0xd0
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 2, eflags: 0x0
// Checksum 0x8cec690f, Offset: 0x1900
// Size: 0x11a
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 2, eflags: 0x0
// Checksum 0x80cb4fd8, Offset: 0x1a28
// Size: 0x1b8
...
// Namespace killstreak_weapons/killstreak_weapons
// Params 4, eflags: 0x0
// Checksum 0x9b8bf481, Offset: 0x1be8
// Size: 0x214
