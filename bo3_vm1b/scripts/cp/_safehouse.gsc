...
function function_109cf997( menuname )
{
    ...
    while ( true )
    {
        ...
        if ( menu == menuname )
        {
            ...
            {
                player_class = self loadout::getclasschoice( response );
                ...
                function_5b426a60( player_class );
