...
function main()
{
    ...
    a_reached_finaltree_triggers = getentarray( "reached_fin" + "altree_triggers", "script_noteworthy" );
...
function objective_supertrees_init( str_objective, b_starting )
{
    ...
    level.ai_hendricks.goalradius = -56;
...
function zipline_gates( e_start, m_mover )
{
    ...
    {
        InvalidOpCode( 0xb5, o_gate_start );
        // Unknown operator ( 0xb5, t7, PC )
    }
}
...
function get_player_zipline_weapon()
{
    ...
    if ( self.b_has_sidearm )
    {
        ...
        else if ( var_d1f13390 == level.w_pistol_standard )
        {
            w_zipline_pistol = level.w_pistol_standard_zipline;
        }
        else if ( var_d1f13390 == level.w_pistol_fullauto )
        {
            w_zipline_pistol = level.w_pistol_fullauto_zipline;
        }
        else if ( var_d1f13390 == level.w_pistol_burst )
        {
