...
// Size: 0xdd
function fx_play_on_tag( localclientnum, str_type, str_fx, str_tag, b_kill_fx_with_same_type, var_ff19846d )
{
...
// Size: 0x11d
function fx_play( localclientnum, str_type, str_fx, b_kill_fx_with_same_type, v_pos, v_forward, v_up, var_ff19846d )
{
    if ( !isdefined( b_kill_fx_with_same_type ) )
    {
        b_kill_fx_with_same_type = 1;
