...
// Params 0, eflags: 0x6
// Checksum 0xb31633f4, Offset: 0xc8
// Size: 0x3c
...
// Namespace radiation/radiation
// Params 0, eflags: 0x4
// Checksum 0x229ab2ed, Offset: 0x110
// Size: 0x6c
...
// Namespace radiation/radiation
// Params 0, eflags: 0x4
// Checksum 0x1dca9434, Offset: 0x188
// Size: 0xfa
...
// Namespace radiation/radiation
// Params 0, eflags: 0x4
// Checksum 0x599755a8, Offset: 0x290
// Size: 0x5c
...
// Namespace radiation/radiation
// Params 0, eflags: 0x4
// Checksum 0xa63e7f49, Offset: 0x2f8
// Size: 0x126
...
// Namespace radiation/radiation
// Params 0, eflags: 0x4
// Checksum 0x64970818, Offset: 0x428
// Size: 0x1e4
function private function_acb192d7() {
    ...
    foreach (sickness, var_46bdb64c in self.radiation.sickness) {
        ...
        if (timems - var_46bdb64c.starttimems > var_46bdb64c.var_f8804aa0) {
...
// Namespace radiation/radiation
// Params 1, eflags: 0x4
// Checksum 0xeb2b7a8a, Offset: 0x618
// Size: 0xa0
...
// Namespace radiation/radiation
// Params 1, eflags: 0x4
// Checksum 0x6e95e98e, Offset: 0x6c0
// Size: 0x17c
...
// Namespace radiation/radiation
// Params 3, eflags: 0x0
// Checksum 0x908cffab, Offset: 0x848
// Size: 0x174
function function_e2336716(player, radiationlevel, sickness) {
    ...
    var_768b78bb = {};
    var_768b78bb.starttimems = gettime();
    var_768b78bb.var_f8804aa0 = var_46bdb64c.duration;
    player.radiation.sickness[sickness] = var_768b78bb;
    radiation_ui::function_59621e3c(player, sickness);
}

// Namespace radiation/radiation
// Params 2, eflags: 0x4
// Checksum 0x611d2e18, Offset: 0x9c8
// Size: 0x114
...
// Namespace radiation/radiation
// Params 3, eflags: 0x0
// Checksum 0xfb591bcd, Offset: 0xae8
// Size: 0x16c
function function_d90ea0e7(sickness, initfunction = undefined, var_dad6905e = undefined) {
    if (!namespace_956bd4dd::function_ab99e60c()) {
        return;
    }
...
// Namespace radiation/radiation
// Params 2, eflags: 0x0
// Checksum 0xf4ec34dc, Offset: 0xc60
// Size: 0xa6
...
// Namespace radiation/radiation
// Params 1, eflags: 0x0
// Checksum 0x4f9dbfe4, Offset: 0xd10
// Size: 0x4e
...
// Namespace radiation/radiation
// Params 2, eflags: 0x0
// Checksum 0x86224691, Offset: 0xd68
// Size: 0x3bc
function function_2f76803d(player, count) {
    ...
    radiation_ui::function_36a2c924(player, count / 5);
    ...
    if (var_5a9583ae > 0) {
        ...
        var_32adf91d = player.radiation.var_32adf91d;
        radiation_ui::function_835a6746(player, player.radiation.var_abd7d46a / level.radiation.levels[var_32adf91d].maxhealth);
        return;
    }
    ...
    if (var_32adf91d >= level.radiation.levels.size) {
        radiation_ui::function_835a6746(player, 1);
        player kill();
        return;
    }
    radiation_ui::function_137e7814(player, player.radiation.var_32adf91d + 1);
