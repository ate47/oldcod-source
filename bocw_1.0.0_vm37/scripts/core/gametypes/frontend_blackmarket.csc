...
// Params 0, eflags: 0x6
// Checksum 0xc0cccfa4, Offset: 0x150
// Size: 0x3c
function private autoexec __init__system__() {
    system::register(#"blackmarket", &preinit, undefined, undefined, undefined);
}

// Namespace blackmarket/frontend_blackmarket
// Params 0, eflags: 0x4
// Checksum 0xda3a6faf, Offset: 0x198
// Size: 0x24
...
// Namespace blackmarket/frontend_blackmarket
// Params 1, eflags: 0x0
// Checksum 0xc6807ef5, Offset: 0x1c8
// Size: 0xc
...
// Namespace blackmarket/frontend_blackmarket
// Params 2, eflags: 0x0
// Checksum 0x6cd13710, Offset: 0x1e0
// Size: 0x14c
...
// Namespace blackmarket/frontend_blackmarket
// Params 2, eflags: 0x0
// Checksum 0xc7ff7525, Offset: 0x338
// Size: 0x28e
...
// Namespace blackmarket/frontend_blackmarket
// Params 2, eflags: 0x0
// Checksum 0x1fcb39ba, Offset: 0x5d0
// Size: 0x142
function function_631642bd(localclientnum, *menu_data) {
    ...
    playmaincamxcam(menu_data, #"ui_cam_blackjack_character", 0, "", "", s_align.origin, s_align.angles);
    level.s_blackmarket = spawnstruct();
    level.s_blackmarket.localclientnum = menu_data;
}

// Namespace blackmarket/frontend_blackmarket
// Params 3, eflags: 0x0
// Checksum 0x5db3bd51, Offset: 0x720
// Size: 0x128
...
// Namespace blackmarket/frontend_blackmarket
// Params 3, eflags: 0x0
// Checksum 0x3285c16a, Offset: 0x850
// Size: 0x6a4
function function_f559e439(localclientnum, menu_data, state) {
    ...
    if (isdefined(var_6b569619)) {
        ...
        if (isdefined(var_f56984dc) && var_f56984dc == "crate") {
            if (is_true(level.s_blackmarket.var_760cf00)) {
...
// Namespace blackmarket/frontend_blackmarket
// Params 3, eflags: 0x0
// Checksum 0x44474ad6, Offset: 0xf00
// Size: 0x3e2
function function_fa73161a(localclientnum, *menu_data, state) {
    if (!is_true(level.s_blackmarket.var_5a133766)) {
        return;
    }
    level notify(#"hash_6cbadb6c7bbdc5f");
    level endoncallback(&function_c3fc514, #"hash_6cbadb6c7bbdc5f", #"hash_7440f3772cbdc5b1");
    level scene_stop(level.s_blackmarket.var_82406a05, 1, menu_data);
    if (is_true(level.s_blackmarket.var_46d8e7d1)) {
        if (!is_true(level.s_blackmarket.var_760cf00)) {
            switch (hash(state)) {
            default:
...
// Namespace blackmarket/frontend_blackmarket
// Params 2, eflags: 0x0
// Checksum 0xfe53e989, Offset: 0x12f0
// Size: 0x15e
...
// Namespace blackmarket/frontend_blackmarket
// Params 1, eflags: 0x0
// Checksum 0xf710edb5, Offset: 0x1458
// Size: 0x56
...
// Namespace blackmarket/frontend_blackmarket
// Params 3, eflags: 0x0
// Checksum 0xce11892a, Offset: 0x14b8
// Size: 0x74
...
// Namespace blackmarket/frontend_blackmarket
// Params 3, eflags: 0x0
// Checksum 0x120e1598, Offset: 0x1538
// Size: 0x288
...
// Namespace blackmarket/frontend_blackmarket
// Params 2, eflags: 0x0
// Checksum 0xbe6dcc2b, Offset: 0x17c8
// Size: 0x22c
function function_99278be8(localclientnum, *menu_data) {
    ...
    level scene_stop(level.s_blackmarket.var_82406a05, 1, menu_data);
    level.s_blackmarket.var_82406a05 = undefined;
    level scene_stop(level.s_blackmarket.var_6b569619, 1, menu_data);
    level.s_blackmarket.var_6b569619 = undefined;
    level scene_stop(level.s_blackmarket.var_ce1b87cf, 1, menu_data);
    level.s_blackmarket.var_ce1b87cf = undefined;
    if (isdefined(level.s_blackmarket.a_exploders)) {
        foreach (var_e153c1aa in level.s_blackmarket.a_exploders) {
            exploder::kill_exploder(var_e153c1aa);
...
// Namespace blackmarket/frontend_blackmarket
// Params 2, eflags: 0x0
// Checksum 0xef8ade7, Offset: 0x1a00
// Size: 0x10c
