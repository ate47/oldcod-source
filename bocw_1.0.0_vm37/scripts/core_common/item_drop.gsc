...
// Params 0, eflags: 0x6
// Checksum 0xaa4f3935, Offset: 0x308
// Size: 0x44
...
// Namespace item_drop/item_drop
// Params 0, eflags: 0x4
// Checksum 0x78f3cb4f, Offset: 0x358
// Size: 0x12c
...
// Namespace item_drop/item_drop
// Params 0, eflags: 0x4
// Checksum 0x16dd46b6, Offset: 0x490
// Size: 0x1e4
...
/#
    ...
    // Namespace item_drop/item_drop
    // Params 0, eflags: 0x4
    // Checksum 0x10fbd96e, Offset: 0x680
    // Size: 0x54
    ...
    // Namespace item_drop/item_drop
    // Params 0, eflags: 0x4
    // Checksum 0xff4bc9cd, Offset: 0x6e0
    // Size: 0x76
...
// Namespace item_drop/item_drop
// Params 5, eflags: 0x4
// Checksum 0x1259b8e0, Offset: 0x760
// Size: 0x1ba
...
// Namespace item_drop/item_drop
// Params 2, eflags: 0x4
// Checksum 0xfa2091ca, Offset: 0x928
// Size: 0x122
...
// Namespace item_drop/item_drop
// Params 0, eflags: 0x4
// Checksum 0xf6365964, Offset: 0xa58
// Size: 0x4c
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x4
// Checksum 0x264f6316, Offset: 0xab0
// Size: 0x7a
...
// Namespace item_drop/item_drop
// Params 6, eflags: 0x4
// Checksum 0x4827cee8, Offset: 0xb38
// Size: 0x494
...
// Namespace item_drop/item_drop
// Params 2, eflags: 0x4
// Checksum 0x16edbc24, Offset: 0xfd8
// Size: 0x8e6
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x4
// Checksum 0x61f45316, Offset: 0x18c8
// Size: 0x19e
...
// Namespace item_drop/item_drop
// Params 6, eflags: 0x4
// Checksum 0xf6cd23b8, Offset: 0x1a70
// Size: 0x9de
...
// Namespace item_drop/item_drop
// Params 5, eflags: 0x0
// Checksum 0xee9a3372, Offset: 0x2458
// Size: 0x5c6
...
// Checksum 0xaec405c6, Offset: 0x2a28
// Size: 0x5e
...
// Params 1, eflags: 0x40
// Checksum 0x7158b920, Offset: 0x2a90
// Size: 0xa6
...
// Namespace item_drop/item_drop
// Params 2, eflags: 0x0
// Checksum 0x1c604aca, Offset: 0x2b40
// Size: 0x94
...
// Namespace item_drop/item_drop
// Params 0, eflags: 0x0
// Checksum 0x8019559c, Offset: 0x2be0
// Size: 0x214
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0x4118e510, Offset: 0x2e00
// Size: 0x36
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0x1cfc6864, Offset: 0x2e40
// Size: 0x2bc
function function_8a47b954(player) {
    ...
    function_fd9026e4(0, item_world_util::function_f4a8d375(inventoryitem.id), isdefined(inventoryitem.count) ? inventoryitem.count : 1, amount, inventoryitem.id, player.origin, player.angles, 2, 0, 0, undefined, undefined, isdefined(inventoryitem.attachments) ? inventoryitem.attachments : undefined, 1, inventoryitem.weaponoptions, inventoryitem.var_e91aba42);
}

// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0xfbd55913, Offset: 0x3108
// Size: 0x1190
function drop_inventory(player) {
    ...
    for (index = 0; index < drop_item_id.size; index++) {
        ...
        item = player function_fd9026e4(index, drop_items[index], drop_count[index], drop_amount[index], drop_item_id[index], deathstash.origin, deathstash.angles, 0, 1, 1, targetname, deathstash, array(), 1, drop_weapon_options[index], var_d148a5b6[index], var_d54d0589[index]);
...
// Checksum 0x9ee48071, Offset: 0x42a0
// Size: 0xa58
function function_30f75868(index = 0, weapon = undefined, count = 0, amount = 0, itemid, position, angles = (0, 0, 0), falling = 2, var_ba40b4c1 = 1, attachments = undefined) {
    ...
    if (level.var_18dc9d17.size > var_2e8786e2) {
        for (index = 0; index < level.var_18dc9d17.size; index++) {
            if (isdefined(level.var_18dc9d17) && isdefined(level.var_18dc9d17.itementry) && is_true(level.var_18dc9d17.itementry.var_4cd830a)) {
                continue;
            }
            level.var_18dc9d17[index].hidetime = gettime();
            item_world::function_a54d07e6(level.var_18dc9d17[index]);
            level.var_18dc9d17[index] delete();
            break;
        }
        if (index >= level.var_18dc9d17.size) {
    ...
    if (falling != 1 && falling != 0) {
        ...
        anglesoffset = function_3b2b6383(position, angles, (0, 0, 1), item.itementry, var_ba40b4c1);
        droptime = dropitem namespace_b637a3ed::drop_item(index, position, angles, falling, 1, originoffset, anglesoffset);
    } else if (falling == 1) {
...
// Namespace item_drop/item_drop
// Params 2, eflags: 0x4
// Checksum 0x8e87b202, Offset: 0x4d00
// Size: 0x9c
...
// Namespace item_drop/item_drop
// Params 2, eflags: 0x4
// Checksum 0x9597c53f, Offset: 0x4da8
// Size: 0x2ac
...
// Namespace item_drop/item_drop
// Params 8, eflags: 0x0
// Checksum 0x4d53f0cd, Offset: 0x5060
// Size: 0x128
...
// Checksum 0x22b07038, Offset: 0x5190
// Size: 0x3c8
function function_fd9026e4(index = 0, weapon = undefined, count = 0, amount = 0, itemid, position, angles = (0, 0, 0), falling = 2, stashitem = 0, deathstash = 0, targetname = undefined, parentent = undefined, attachments = undefined, var_ba40b4c1 = 1, weaponoptions = undefined, var_e91aba42 = undefined, var_1181c08b = undefined, stockammo = undefined, aat = undefined, paplv = undefined) {
...
// Namespace item_drop/item_drop
// Params 0, eflags: 0x0
// Checksum 0x1c4cbfe0, Offset: 0x5560
// Size: 0x112
...
// Namespace item_drop/item_drop
// Params 3, eflags: 0x0
// Checksum 0xed22669d, Offset: 0x5680
// Size: 0x26a
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0xabe14c10, Offset: 0x58f8
// Size: 0x62
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0x476da889, Offset: 0x5968
// Size: 0x54
...
// Namespace item_drop/item_drop
// Params 2, eflags: 0x0
// Checksum 0x5603ba3f, Offset: 0x59c8
// Size: 0xa0
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0x3a406e6b, Offset: 0x5a70
// Size: 0x44
...
// Namespace item_drop/item_drop
// Params 0, eflags: 0x0
// Checksum 0x4b0bca11, Offset: 0x5ac0
// Size: 0x12
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0x6166bdb5, Offset: 0x5ae0
// Size: 0x6e
...
// Namespace item_drop/item_drop
// Params 1, eflags: 0x0
// Checksum 0x4c215153, Offset: 0x5b58
// Size: 0x84
...
/#
    ...
    // Namespace item_drop/item_drop
    // Params 3, eflags: 0x0
    // Checksum 0xd76f3bd7, Offset: 0x5be8
    // Size: 0x114
    ...
    // Namespace item_drop/item_drop
    // Params 3, eflags: 0x0
    // Checksum 0xc4ae5e25, Offset: 0x5d08
    // Size: 0x10c
